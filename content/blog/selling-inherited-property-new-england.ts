...
const content: BlogPostContent = {
  ...
  sections: [
    ...
    {
      heading: 'Massachusetts Probate: The Uniform Probate Code',
      paragraphs: [
      ...
      callout: {
        type: 'blue',
        title: 'Probate courts for Massachusetts markets',
        text: 'Hampden County Probate and Family Court: 50 State Street, Springfield MA, (413) 748-7776. Worcester County Probate and Family Court: 225 Main Street, Worcester MA, (508) 770-0825.',
      },
    },
    {
      heading: 'New Hampshire Probate: Efficient for Uncontested Estates',
      paragraphs: [
    ...
    {
      heading: 'Connecticut Probate: A Town-by-Town System',
      paragraphs: [
    ...
    },
    {
      ...
      table: {
        headers: ['Factor', 'Massachusetts', 'New Hampshire', 'Connecticut'],
        rows: [
          ['Probate statute', 'MGL Ch. 190B', 'RSA 547', 'CGS Title 45a'],
          ['Court structure', 'County Probate Courts', 'Circuit Court — Probate Division', 'Town/city Probate Courts (54 total)'],
          ['Informal/uncontested timeline', '2–4 months', '2–4 months', '2–6 months (varies by municipality)'],
          ['Formal/contested timeline', '6–18+ months', '6–18+ months', '12–24+ months'],
          ...
          ['Court sale approval required?', 'No for informal probate (§3-704)', 'No for clear testamentary authority', 'Generally yes, but local judge has discretion'],
          ['Attorney state?', 'Yes (MGL Ch. 221 §46A)', 'Yes (recommended/de facto required)', 'Yes (CGS §51-88)'],
        ],
      },
    },
    {
      heading: 'Selling an Inherited Property During Probate — What You Can and Can\'t Do',
      paragraphs: [
    ...
    {
      heading: 'Specific Situations We Handle in New England Estate Sales',
      paragraphs: [
    ...
    {
      heading: 'Next Steps: Getting a Cash Offer on Your Inherited New England Property',
      paragraphs: [
  ...
  faq: [
    {
      question: 'Can I sell an inherited house during probate in Massachusetts?',
      answer:
        'Yes — you can list the property, accept offers, and sign a purchase agreement during Massachusetts probate. The deed cannot transfer until the personal representative has Letters Testamentary or Letters of Administration from the Probate and Family Court. Under MGL Ch. 190B §3-704, the personal representative can sell estate real property without further court order in informal probate proceedings. A cash buyer can often close within days of Letters being issued. Source: malegislature.gov.',
    },
    {
      question: 'How long does New Hampshire probate take for an inherited house?',
      answer:
        'New Hampshire probate for an uncontested estate with a clear will typically takes 2–4 months from filing to issuance of the executor\'s authority. The New Hampshire Circuit Court — Probate Division (RSA 547) handles estate administration in each county. For Manchester-area estates, the Hillsborough County Probate Court is at 300 Chestnut Street, Manchester NH 03101, (603) 669-7410. Complex or contested estates can take 12–24 months. Source: gencourt.state.nh.us.',
    },
    {
      question: 'How does Connecticut probate work for inherited real estate?',
      answer:
        'Connecticut has 54 separate municipal probate courts — one for each major town and city. When someone dies owning real estate in Bridgeport, the estate goes through the Bridgeport Probate Court at 45 Lyon Terrace Room 121, (203) 576-7957. The local probate judge has broad authority. Uncontested estates often resolve in 2–6 months; contested matters can take 12–24+ months. Small estates under $40,000 in personal property may qualify for Voluntary Administration, but real estate requires full probate. Source: ct.gov/probate.',
    },
    {
      question: 'Do I have to pay capital gains tax when selling an inherited property?',
      answer:
        'Inherited property generally receives a "stepped-up basis" equal to the fair market value at the date of death. This means capital gains tax applies only to appreciation after the date of inheritance — not the full value increase during the prior owner\'s lifetime. On a property that hasn\'t appreciated much since inheritance, the capital gains tax exposure may be minimal. This applies to federal tax; Massachusetts has its own income tax of 5% on capital gains, and Connecticut taxes capital gains as ordinary income. Consult a tax professional for your specific situation. Source: IRS Publication 559 (irs.gov).',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. USA Home Buyers purchases inherited properties in any condition — contents included. You take what has sentimental or financial value and leave the rest. We handle cleanout. This is particularly practical for out-of-state heirs managing a Massachusetts, New Hampshire, or Connecticut property from a distance.',
    },
  ],

  relatedLinks: [
    { href: '/markets/springfield-ma', label: 'Sell Inherited House — Springfield MA' },
    { href: '/markets/worcester-ma', label: 'Sell Inherited House — Worcester MA' },
    { href: '/markets/manchester-nh', label: 'Sell Inherited House — Manchester NH' },
    { href: '/markets/bridgeport-ct', label: 'Sell Inherited House — Bridgeport CT' },
    { href: '/blog/how-to-sell-house-fast-massachusetts', label: 'How to Sell a House Fast in Massachusetts' },
    { href: '/sell-house-fast-massachusetts', label: 'Massachusetts Cash Home Buyers' },
    { href: '/sell-house-fast-new-hampshire', label: 'New Hampshire Cash Home Buyers' },
    { href: '/sell-house-fast-connecticut', label: 'Connecticut Cash Home Buyers' },
    { href: '/resources/how-the-process-works', label: 'How Our Cash Buying Process Works' },
  ],

  ctaHeadline: 'Inherited a Property in New England? We Can Help.',
  ctaSubheadline:
