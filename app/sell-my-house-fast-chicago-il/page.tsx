...
const localBusinessSchema = {
  ...
  telephone: PHONE,
  url: `${SITE_URL}/sell-my-house-fast-chicago-il`,
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Sell My House Fast Chicago IL', item: `${SITE_URL}/sell-my-house-fast-chicago-il` },
  ],
};
  ...
  return (
    <>
      <SchemaMarkup schema={[localBusinessSchema, faqSchema(FAQ_ITEMS), breadcrumbSchema, videoObjectSchema({
          ...
          description:
            'A short overview of how USA Home Buyers helps Chicago, IL homeowners sell as-is for cash with no repairs, no agent commissions, and a no-obligation offer.',
          ...
          <div>
            ...
            <div className="lg:hidden mb-4">
              <CashOfferForm
                ...
                sourcePage="/sell-my-house-fast-chicago-il"
              />
            </div>
