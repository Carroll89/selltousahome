...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/sell-my-house-fast-cincinnati-oh` },
};
...
const localBusinessSchema = {
  ...
  telephone: PHONE,
  url: `${SITE_URL}/sell-my-house-fast-cincinnati-oh`,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Sell My House Fast Cincinnati OH', item: `${SITE_URL}/sell-my-house-fast-cincinnati-oh` },
  ],
};
  ...
  return (
    <>
      <SchemaMarkup schema={[localBusinessSchema, faqSchema(FAQ_ITEMS), breadcrumbSchema, videoObjectSchema({
          ...
          description:
            'A short overview of how USA Home Buyers helps Cincinnati, OH homeowners sell as-is for cash with no repairs, no agent commissions, and a no-obligation offer.',
          ...
          <div>
            ...
            <div className="lg:hidden mb-4">
              <CashOfferForm
                ...
                sourcePage="/sell-my-house-fast-cincinnati-oh"
              />
            </div>
