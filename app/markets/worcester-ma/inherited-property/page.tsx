    ...
    <>
          ...
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                USA Home Buyers purchases inherited properties in Worcester MA through Worcester County Probate and Family Court. Written cash offer in 24 hours, close after probate grants authority. Any condition, no repairs, no cleanout. Call 888-274-5006.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            We frequently work with estates throughout Worcester County. We can have a written offer ready before you even file for probate, so you can close once authority is granted; court process can vary. Redfin city median sale price: $499,250 (+12.2% YoY, March 2026); Zillow Research City ZHVI: $430,112 (+1.0% YoY, March 2026). Transfer tax: Massachusetts deed excise stamps — $4.56 per $1,000 of consideration, paid by seller. On a $499,250 sale: ~$2,277. Source: Massachusetts DOR (mass.gov).
          </p>
        </section>
