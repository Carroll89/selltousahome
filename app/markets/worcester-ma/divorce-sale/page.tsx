...
const pageUrl = `${SITE_URL}/markets/worcester-ma/divorce-sale`;

export const metadata: Metadata = {
  title: 'Sell House in Divorce Worcester MA',
  description:
    'Selling a house in divorce in Worcester MA? We buy quickly so proceeds can split cleanly. Written offer in 24 hours. Close in 7 days.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Can I sell my house during a divorce in Worcester MA?',
  ...
  },
  {
    ...
    answer: 'Not necessarily. With power of attorney or signed documents, it\'s possible for one party to complete closing on behalf of both. Your closing attorney in Worcester County can advise on the mechanics.',
  },
];

export default function WorcesterDivorceSalePage() {
  return (
    <>
      <SchemaMarkup schema={[
        worcesterLocalBusinessSchema,
        articleSchema('Sell Your Worcester MA House in Divorce — Fast, Clean Settlement', pageUrl, '2026-04-16'),
        faqSchema(FAQ_ITEMS),
      ]} />
      ...
      <section className="relative text-white py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          ...
          <img
            ...
            alt="Worcester MA homes — Sell Your Worcester MA House in Divorce — Fast, Clean Settlement"
            fetchPriority="high"
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-blue-300 text-sm font-medium mb-2">
              <Link href="/markets/worcester-ma" className="hover:text-white">Worcester MA</Link> › Divorce Sale
            </p>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell Your Worcester MA House in Divorce — Fast, Clean Settlement
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">USA Home Buyers purchases houses in Worcester MA during divorce proceedings. We give one written offer, one closing date, and proceeds split through attorneys at closing. Written cash offer in 24 hours, close in 7-14 days. No repairs. Call 888-440-5250.</p>
            </div>
          ...
          <div>
            <CashOfferForm variant="hero" headline="Get Your Cash Offer" subheadline="Written offer in 24 hours. We cover all closing costs." sourcePage="/markets/worcester-ma/divorce-sale" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Divorce Sale in Worcester MA" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Worcester MA Property?" sourcePage="/markets/worcester-ma/divorce-sale" />
      </div>
    </>
  );
}
