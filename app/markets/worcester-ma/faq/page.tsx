...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'All of Worcester County and surrounding areas including Shrewsbury, Auburn, Millbury, Grafton, Holden. Call 888-274-5006 if you\'re not sure whether your address is in our coverage area.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8">
          <p className="text-sm text-blue-900">
            Common questions from Worcester homeowners about selling for cash. If your question isn't here, call 888-274-5006.
          </p>
        </div>
