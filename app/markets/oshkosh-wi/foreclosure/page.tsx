  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Facing Foreclosure in Oshkosh WI?',
          description: 'Sell before the sheriff\'s sale — protect your equity and credit in Winnebago County',
          contentUrl: `${SITE_URL}/videos/oshkosh-wi/foreclosure.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/oshkosh-wi/foreclosure-poster.jpg`,
        }),
      ]} />
...
<VideoEmbed
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            After judgment, you'll receive notice of the redemption period expiration and the scheduled sheriff's sale date; court process can vary. In Winnebago County, sheriff's sales are published in a local newspaper of general circulation as required by Wis. Stat. § 846.16. The sale is a public auction — the lender typically bids the amount of the outstanding judgment, and third-party bidders may bid higher. If you're in the redemption period and want to sell, you must complete the closing before the sheriff's sale is confirmed by the court under § 846.17. After confirmation, your right to redeem is extinguished permanently.
          </p>
