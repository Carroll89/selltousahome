  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a Rental Property in Oshkosh WI',
          description: 'Done with landlording? We buy tenant-occupied homes as-is in Winnebago County',
          contentUrl: `${SITE_URL}/videos/oshkosh-wi/tenant-occupied.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/oshkosh-wi/tenant-occupied-poster.jpg`,
        }),
      ]} />
