  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a Fire-Damaged House in Oshkosh WI',
          description: 'No restoration required — we buy fire-damaged homes as-is in Winnebago County',
          contentUrl: `${SITE_URL}/videos/oshkosh-wi/fire-damage.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/oshkosh-wi/fire-damage-poster.jpg`,
        }),
      ]} />
