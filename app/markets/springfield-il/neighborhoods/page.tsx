...
export const metadata: Metadata = {
  ...
  description:
    'Springfield IL neighborhood guide for sellers. Enos Park, Harvard Park, West Side, Aristocracy Hill — we buy in every Springfield neighborhood. 888-440-5250.',
