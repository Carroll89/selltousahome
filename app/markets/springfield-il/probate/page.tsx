  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling Probate Property in Springfield IL',
          description: 'Working with executors and Sangamon County Circuit Court',
          contentUrl: `${SITE_URL}/videos/springfield-il/probate.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/probate-poster.jpg`,
        }),
      ]} />
