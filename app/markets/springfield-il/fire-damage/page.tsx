    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Selling the damaged property as-is captures the land value (which persists regardless of structural condition) plus whatever value remains in the damaged structure. In Springfield's current market — Redfin median sale price $187,000, up 23% year-over-year — land values in established neighborhoods are meaningful. A vacant fire-damaged lot in Harvard Park or Enos Park has real value to a builder or investor.
          </p>
        </section>
