  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling a House During Divorce in Springfield IL',
          description: 'One offer, one closing, clean split of proceeds in Sangamon County',
          contentUrl: `${SITE_URL}/videos/springfield-il/divorce-sale.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/divorce-sale-poster.jpg`,
        }),
      ]} />
