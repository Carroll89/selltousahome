    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            The marital home is typically one of the largest assets in a Sangamon County divorce. Springfield's market appreciation has increased the equity in homes purchased before 2022 significantly — the 23% year-over-year increase in Redfin's March 2026 median sale price means even modest bungalows in Harvard Park and on the West Side have built substantial equity. Getting that equity out cleanly requires a buyer, and a cash sale is the fastest path when both parties are ready to move on.
          </p>
        </section>
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Springfield's housing market appreciation makes the divorce home sale conversation more consequential than it was a few years ago. The Redfin median sale price of $187,000 in March 2026 — up 23% year over year — means that many Springfield couples who bought before 2022 are sitting on substantially more equity than when they purchased. On a home bought in 2018 or 2019 at $130,000 with a remaining balance of $100,000, current market value around $163,000-$187,000 creates $63,000-$87,000 in equity to divide.
          </p>
          <p className="text-gray-700 mb-4">
