  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell Inherited House in Springfield IL',
          description: 'We handle probate, as-is purchase, and fast close in Sangamon County',
          contentUrl: `${SITE_URL}/videos/springfield-il/inherited-property.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/inherited-property-poster.jpg`,
        }),
      ]} />
