  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a Rental Property in Springfield IL',
          description: 'Done with being a landlord? We buy tenant-occupied homes as-is',
          contentUrl: `${SITE_URL}/videos/springfield-il/tenant-occupied.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/tenant-occupied-poster.jpg`,
        }),
      ]} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            For landlords, Springfield's current market appreciation is worth noting. Per Redfin (March 2026), the median sale price hit $186,000 — up 22.4% year-over-year. Even properties that need significant work are worth more than they were in 2022 or 2023. If you've been holding a rental property for 5-10 years, the equity you've built may be substantial. A cash sale captures that equity cleanly without the carrying costs and tenant-management burden of a retail listing.
          </p>
          <p className="text-gray-700 mb-4">
