  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a House With Code Violations in Springfield IL',
          description: 'Open violations, condemned notices - we buy as-is',
          contentUrl: `${SITE_URL}/videos/springfield-il/code-violations.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/code-violations-poster.jpg`,
        }),
      ]} />
