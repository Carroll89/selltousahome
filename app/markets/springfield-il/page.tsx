...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/springfield-il-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Springfield IL home — Sell Your House Fast for Cash",
      },
    ],
  },
};
  ...
  areaServed: [
    {
      "@type": "City",
      name: "Springfield",
      sameAs: "https://en.wikipedia.org/wiki/Springfield,_Illinois",
    },
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "I owned a rental on Maywood Drive for six years. Fine until the tenant stopped paying and started subletting to three other people I had never approved. Code enforcement showed up twice. USA Home Buyers bought it with the tenants still inside. I didn't have to do a single eviction filing. Nine days from first call to closing.",
    name: "Christine D.",
  ...
  {
    quote:
      "My husband retired from the Illinois State Library after thirty-one years. We'd talked about moving to Florida for years. The house in North Glenwood was fine — just bigger than we needed. USA Home Buyers gave us a fair offer. We closed in eight days and were in Sarasota before the weather turned cold.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "$0",
    traditional: "5-6% (~$9,300-$11,160 on Springfield median)",
  },
  {
    label: "IL transfer tax (state + county)",
    cashBuyer: "We cover everything",
    traditional: "$0.75/$500 combined — seller pays ~$280 on median",
  },
  {
...
const FAQ_ITEMS = [
  ...
  {
    question:
      "What is the transfer tax when selling a house in Springfield IL?",
    answer:
...
export default function SpringfieldILMarketPage() {
  const howToSchema = {
    ...
    description:
      "Step-by-step process for selling your Springfield or Sangamon County home for cash",
    step: [
      {
        "@type": "HowToStep",
        name: "Submit Your Property Info",
        text: "Fill out our 2-minute form with your Springfield or Sangamon County property address, condition, and timeline.",
        position: 1,
      },
      {
        "@type": "HowToStep",
      ...
      },
      {
        ...
        text: "Sign at a Springfield IL title company of your choice, walk away with your cash. No repairs, no cleanout.",
        position: 4,
      },
    ],
  };
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Springfield IL cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Springfield house in any
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              Springfield IL mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Springfield IL homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Springfield IL section for local market data,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-12">
          <h2 className="text-2xl md:text-3xl font-bold text-brand-dark mb-6">
            Springfield IL Real Estate Market — What Sellers Need to Know in
            2026
          </h2>
          <p className="text-gray-700 mb-4">
            Springfield is Illinois's state capital and Sangamon County's seat —
            a city of 113,330 people built on government employment, Lincoln-era
            history, and a housing stock that ranges from 1880s Victorian
            mansions in Enos Park and Aristocracy Hill to post-war brick ranches
            on the West Side. Realtor.com ranked Springfield the #10 hottest
            market in the country as of March 2026 (hotness score 93.979, median
            active listing days on market 31.5 days) — an unusual position for a
            downstate Midwest city of this size.
          </p>
          <p className="text-gray-700 mb-4">
            That heat comes from a specific combination: affordable entry
            prices, a stable government employment base (Illinois state
            government is Springfield's largest employer), and a significant
            volume of older housing stock in need of renovation that
            conventional buyers can't easily finance. Enos Park's Victorian-era
            cottages — some pre-dating 1900 — frequently have original
            knob-and-tube wiring, galvanized plumbing, and plaster walls that
            rule out FHA and conventional financing entirely. Harvard Park
            bungalows from the 1940s and '50s often carry the same limitations.
            That's where cash buyers operate.
          </p>
          <p className="text-gray-700 mb-4">
            State-capital dynamics add another seller motivation that's unique
            to Springfield: government employees subject to workforce
            reductions, inter-agency transfers, and pension-related financial
            stress need to move fast. When a position gets transferred to
            Chicago or downstate budget cuts result in layoffs, the time from
            decision to departure is short — and listing retail, staging, and
            waiting 28-45 days for a conventional buyer isn't practical.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">$0.75 per $500 (0.15%) — seller pays</td>
                  <td className="p-3 text-gray-500">
                    35 ILCS 200/31-10; Sangamon Recorder
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Foreclosure type</td>
                  <td className="p-3">
                    Judicial — 735 ILCS 5/15-1101 (12-15 mos typical)
                  </td>
                  <td className="p-3 text-gray-500">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">
                    Sangamon Co. Circuit Court, 200 S 9th St 7th Fl, (217)
                    753-6674
                  </td>
                  <td className="p-3 text-gray-500">7th Judicial Circuit</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-600 italic">
            What this means for Springfield sellers: the market is genuinely hot
            — a 28-day median DOM means the right retail listing moves fast. But
            "right retail listing" excludes most of Springfield's older housing
            stock. If your home needs significant work, has title complications
            (estate, foreclosure, divorce), or you simply need speed without the
            hassle of showings and contingencies, a direct cash offer is the
            practical path. The 5-6% agent commission on a $186,000 median home
            runs $9,300-$11,160 before closing costs and repair requests.
          </p>
        </section>
          ...
          situations={[
            {
              ...
              href: "/markets/springfield-il/inherited-property",
              description:
                "Sell an inherited Springfield home — we work with Sangamon County Circuit Court Probate Division timelines",
            },
            {
              label: "Going Through Divorce",
              href: "/markets/springfield-il/divorce-sale",
              description:
                "One offer, one closing — equitable distribution without the delay under 750 ILCS 5/503",
            },
            {
              label: "Facing Foreclosure",
              href: "/markets/springfield-il/foreclosure",
              description:
                "IL judicial foreclosure (735 ILCS 5/15-1101) — sell before the Sangamon County auction",
            },
            {
              label: "Probate Sale",
              href: "/markets/springfield-il/probate",
              description:
                "We work with Sangamon County Circuit Court Probate Division cases, independent and supervised administration",
            },
            {
              label: "Tenant-Occupied Property",
              href: "/markets/springfield-il/tenant-occupied",
              description:
                "We buy with tenants in place — no eviction required before closing in Illinois",
            },
            {
              label: "Code Violations",
              href: "/markets/springfield-il/code-violations",
              description:
                "City of Springfield open violations, condemned properties — we buy anyway, as-is",
            },
            {
              label: "Fire Damage",
              href: "/markets/springfield-il/fire-damage",
              description:
                "Fire or smoke damage in Springfield? We purchase as-is with no cleanup required",
            },
          ]}
        />
        <TestimonialBlock
          testimonials={TESTIMONIALS}
          heading="What Springfield IL Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            On a $186,000 Springfield home, a 5-6% agent commission runs
            $9,300-$11,160. Add Illinois's combined transfer tax ($279.00),
            carrying costs during 28+ days on market, and repair requests on
            pre-1970 housing stock. Enos Park Victorians and Harvard Park
            bungalows frequently have deferred-maintenance issues — original
            wiring, galvanized plumbing, cracked foundations — that conventional
            lenders flag and require remediation before closing. A cash offer
            eliminates the inspection contingency and the repair negotiation
            entirely. At $163,198 average home value, every dollar of commission
            and repair cost is significant.
          </p>
        </section>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Springfield IL Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our Springfield coverage includes the entire city — downtown
            Springfield and the Capitol neighborhood (ZIP 62701), Enos Park with
            its National Register Victorian-era homes, Aristocracy Hill and the
            Old Governor's Mansion corridor, Harvard Park and mid-century South
            Side bungalows, the West Side brick ranch neighborhoods, and the
            north side residential areas around Ridgely and North Grand Avenue.
          </p>
          <p className="text-gray-700 mb-4">
            We serve the surrounding Sangamon County communities throughout —
            Chatham (8 miles south), Rochester (8 miles east), Sherman (8 miles
            north along I-55), Riverton (7 miles north on the Sangamon River),
            Leland Grove, Jerome, Auburn, Pawnee, New Berlin, Pleasant Plains,
            and Mechanicsburg. We also cover properties in adjacent Menard
            County (Petersburg, New Salem area) due to market proximity.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            Springfield IL Neighborhoods We Serve
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            From Enos Park Victorians to Harvard Park bungalows to West Side
            brick ranches — we buy in every Springfield neighborhood and every
            Sangamon County community.
          </p>
          <Link
            href="/markets/springfield-il/neighborhoods"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            See Springfield neighborhood-by-neighborhood price ranges →
          </Link>
        </section>

        <section className="my-8 bg-blue-50 border border-blue-100 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            New to Illinois? So Are We.
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            Springfield is our first Illinois market. We chose it because of its
            #10 national hotness ranking, Springfield's state-capital employment
            dynamics, and the volume of older housing stock that needs a cash
            buyer. For statewide Illinois legal context — transfer taxes,
          ...
          <Link
            ...
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            Read the Illinois Seller's Legal Guide →
          </Link>
        </section>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              ...
              your Springfield IL or Sangamon County home.
            </p>
          </div>
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Springfield IL Home?"
            sourcePage="/markets/springfield-il"
          />
        </section>
      </div>
