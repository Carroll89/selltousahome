  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Facing Foreclosure in Springfield IL?',
          description: 'Sell before the court date — keep your equity, protect your credit',
          contentUrl: `${SITE_URL}/videos/springfield-il/foreclosure.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/springfield-il/foreclosure-poster.jpg`,
        }),
      ]} />
      ...
      <VideoEmbed
        src="/videos/springfield-il/foreclosure.mp4"
        title="Facing Foreclosure in Springfield IL?"
        poster="/videos/springfield-il/foreclosure-poster.jpg"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Per Redfin (March 2026), Springfield's median sale price is $186,000 with homes selling in 28 days median and a 98.4% sale-to-list ratio. Per the Zillow Home Value Index (March 2026), the typical Springfield home value is $163,198, up 8.2% year over year. This is important context for a foreclosure decision: Springfield's market is genuinely strong right now, and the spread between what a cash buyer will pay you versus what the lender typically recovers at auction is significant.
          </p>
          <p className="text-gray-700 mb-4">
            Foreclosure auctions in Sangamon County typically recover 60-75% of fair market value for the lender. Our cash offers for Springfield foreclosure properties run 70–80% of FMV before property-specific adjustments, with the critical difference being that you — not the lender — receive the proceeds above the payoff. If your Springfield bungalow is worth $163,000 and you owe $130,000, selling to us at $122,000 nets you roughly $92,000 after paying off the loan (less closing costs, which we cover). Letting the auction happen means the lender collects, and if the auction price falls short, the lender can pursue a deficiency judgment for the difference.
          </p>
          <p className="text-gray-700 mb-4">
