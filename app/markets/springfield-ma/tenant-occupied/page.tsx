        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">USA Home Buyers purchases tenant-occupied properties in Springfield MA — problem tenants, non-payers, holdovers. We buy with tenants in place. Written cash offer in 24 hours, close in 7-14 days. No eviction process required on your end. Call 888-440-5250.</p>
            </div>
