...
import { springfieldLocalBusinessSchema, faqSchema, videoObjectSchema } from '@/lib/schema';
  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        howToSchema,
        videoObjectSchema({ name: 'Sell My House Fast Springfield MA — USA Home Buyers', description: 'Cash offers for Springfield and Hampden County homes — any condition', contentUrl: `${SITE_URL}/videos/springfield-ma/landing.mp4`, thumbnailUrl: `${SITE_URL}/videos/springfield-ma/landing-poster.jpg`, uploadDate: '2026-04-28' }),
      ]} />
      ...
      <VideoEmbed
        ...
        poster="/videos/springfield-ma/landing-poster.jpg"
        />
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              Springfield mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Springfield homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Springfield section for local market data, situation
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/springfield-ma/resources"
            ...
            <Link
              href="/guides/sell-house-fast-springfield-ma-2026"
