    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            According to the Massachusetts Probate and Family Courts, informal probate timelines vary; 2-4 months for uncontested estates is planning context, not a guaranteed timeline. Once the personal representative receives their Letters of Authority, they can execute a purchase and sale agreement and proceed to closing. We frequently work with estates in this process and can have a written offer ready before probate even begins, so you can close quickly once authority is granted.
          </p>
          <p className="text-gray-700 mb-4">
