...
const pageUrl = `${SITE_URL}/markets/richmond-va/code-violations`;

export const metadata: Metadata = {
  title: 'Sell House With Code Violations Richmond VA -- As-Is Cash Buyers',
  description: 'House with code violations in Richmond VA? USA Home Buyers buys as-is -- no repairs required, cash offer in 24 hours.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Will you buy a house with open code violations in Richmond?', answer: 'Yes. USA Home Buyers purchases properties with open code violations, outstanding permits, unpaid fines, and unsafe structures as-is. The violations are factored into our offer. Call 888-274-5006.' },
...
export default function RichmondCodeViolationsPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          richmondLocalBusinessSchema,
          articleSchema('Sell a House With Code Violations in Richmond VA -- We Buy As-Is', pageUrl, '2026-05-03'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a House With Code Violations in Richmond VA -- We Buy As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">Quick Answer</p>
              <p className="text-white text-sm leading-relaxed">House with code violations in Richmond VA? USA Home Buyers buys as-is -- no repairs required, cash offer in 24 hours.</p>
            </div>
          ...
          <div className="w-full">
            <CashOfferForm variant="hero" headline="Get Your Richmond VA Cash Offer" sourcePage="/markets/richmond-va/code-violations" />
          </div>
        </div>
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <FAQSection items={FAQ_ITEMS} heading="FAQs -- Sell House With Code Violations Richmond VA -- As-Is Cash Buyers" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Richmond VA Home?" sourcePage="/markets/richmond-va/code-violations" />
      </div>
    </>
  );
}
