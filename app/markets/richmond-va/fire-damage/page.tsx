...
const pageUrl = `${SITE_URL}/markets/richmond-va/fire-damage`;

export const metadata: Metadata = {
  title: 'Sell Fire Damaged House Richmond VA -- Cash Buyers',
  description: 'Fire damaged house in Richmond VA? USA Home Buyers purchases fire-damaged properties as-is -- cash offer in 24 hours.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Will you buy a fire-damaged house in Richmond?', answer: 'Yes. USA Home Buyers purchases fire-damaged and smoke-damaged properties as-is. Structural damage, charred framing, smoke odor -- we buy it regardless of condition. Call 888-274-5006.' },
...
export default function RichmondFireDamagePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          richmondLocalBusinessSchema,
          articleSchema('Sell a Fire Damaged House in Richmond VA -- As-Is Cash Offer', pageUrl, '2026-05-03'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Fire Damaged House in Richmond VA -- As-Is Cash Offer
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">Quick Answer</p>
              <p className="text-white text-sm leading-relaxed">Fire damaged house in Richmond VA? USA Home Buyers purchases fire-damaged properties as-is -- cash offer in 24 hours.</p>
            </div>
          ...
          <div className="w-full">
            <CashOfferForm variant="hero" headline="Get Your Richmond VA Cash Offer" sourcePage="/markets/richmond-va/fire-damage" />
          </div>
        </div>
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <FAQSection items={FAQ_ITEMS} heading="FAQs -- Sell Fire Damaged House Richmond VA -- Cash Buyers" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Richmond VA Home?" sourcePage="/markets/richmond-va/fire-damage" />
      </div>
    </>
  );
}
