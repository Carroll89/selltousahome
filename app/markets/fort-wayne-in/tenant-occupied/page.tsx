...
const pageUrl = `${SITE_URL}/markets/fort-wayne-in/tenant-occupied`;

export const metadata: Metadata = {
  title: 'Sell Tenant-Occupied House Fort Wayne IN -- Cash Buyers',
  description: 'Tenant-occupied rental in Fort Wayne IN? USA Home Buyers purchases with tenants in place as-is -- cash offer in 24 hours.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Will you buy a house with tenants still in it in Fort Wayne?', answer: 'Yes. USA Home Buyers purchases tenant-occupied properties as-is. We deal with the tenant situation after closing -- you don\'t need to handle eviction, lease termination, or relocation. Call 888-274-5006.' },
...
export default function FortWayneTenantOccupiedPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          fortWayneLocalBusinessSchema,
          articleSchema('Sell a Tenant-Occupied House in Fort Wayne IN -- We Buy Rentals As-Is', pageUrl, '2026-05-03'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Tenant-Occupied House in Fort Wayne IN -- We Buy Rentals As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">Quick Answer</p>
              <p className="text-white text-sm leading-relaxed">Tenant-occupied rental in Fort Wayne IN? USA Home Buyers purchases with tenants in place as-is -- cash offer in 24 hours.</p>
            </div>
          ...
          <div className="w-full">
            <CashOfferForm variant="hero" headline="Get Your Fort Wayne IN Cash Offer" sourcePage="/markets/fort-wayne-in/tenant-occupied" />
          </div>
        </div>
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <FAQSection items={FAQ_ITEMS} heading="FAQs -- Sell Tenant-Occupied House Fort Wayne IN -- Cash Buyers" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Fort Wayne IN Home?" sourcePage="/markets/fort-wayne-in/tenant-occupied" />
      </div>
    </>
  );
}
