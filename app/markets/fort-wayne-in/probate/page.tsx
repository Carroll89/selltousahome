...
const pageUrl = `${SITE_URL}/markets/fort-wayne-in/probate`;

export const metadata: Metadata = {
  title: 'Sell Probate House Fort Wayne IN -- Allen County Estate Property',
  description: 'Selling a probate property in Fort Wayne IN? We work with Allen County probate timelines -- cash offer, close when authorized.',
...
const FAQ_ITEMS = [
  ...
  { question: 'What closing costs apply?', answer: 'No Indiana transfer tax (abolished 2009); Sales Disclosure Form required at recording. USA Home Buyers covers all closing costs.' },
...
export default function FortWayneProbatePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          fortWayneLocalBusinessSchema,
          articleSchema('Sell a Probate Property in Fort Wayne IN -- Allen County Estate Sale', pageUrl, '2026-05-03'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Probate Property in Fort Wayne IN -- Allen County Estate Sale
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">Quick Answer</p>
              <p className="text-white text-sm leading-relaxed">Selling a probate property in Fort Wayne IN? We work with Allen County probate timelines -- cash offer, close when authorized.</p>
            </div>
          ...
          <div className="w-full">
            <CashOfferForm variant="hero" headline="Get Your Fort Wayne IN Cash Offer" sourcePage="/markets/fort-wayne-in/probate" />
          </div>
        </div>
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <FAQSection items={FAQ_ITEMS} heading="FAQs -- Sell Probate House Fort Wayne IN -- Allen County Estate Property" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Fort Wayne IN Home?" sourcePage="/markets/fort-wayne-in/probate" />
      </div>
    </>
  );
}
