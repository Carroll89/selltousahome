...
const pageUrl = `${SITE_URL}/markets/northampton-ma/fire-damage`;

export const metadata: Metadata = {
  title: 'Sell Fire-Damaged House Northampton MA — We Buy As-Is Cash',
  description:
    'Need to sell a fire-damaged or smoke-damaged house in Northampton MA? USA Home Buyers purchases fire-damaged homes as-is in Hampshire County — cash offer in 24 hours, no repairs required.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Will you buy a fire-damaged house in Northampton MA?',
    answer:
      "Yes. We purchase fire-damaged and smoke-damaged homes throughout Northampton and Hampshire County as-is. No cleanup, no repairs, no board-up required on your end. We make an offer based on current condition and close quickly. Call 888-274-5006.",
  },
  {
  ...
  {
    question: 'What if the City of Northampton has red-tagged or condemned the property?',
    answer:
  ...
  {
    question: 'What does a fire-damaged house in Northampton typically sell for?',
    answer:
      "It depends on the extent of damage, the underlying property value, and the lot. Our offer reflects current as-is condition. Even significantly damaged properties in established Hampshire County neighborhoods retain land value. Call 888-274-5006 for a specific assessment.",
  },
];
...
export default function NorthamptonFireDamagePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          northamptonLocalBusinessSchema,
          articleSchema('Sell a Fire-Damaged House in Northampton MA', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Fire-Damaged House in Northampton MA — Cash As-Is Buyer
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">
                USA Home Buyers purchases fire-damaged and smoke-damaged homes throughout Northampton
                and Hampshire County — any level of damage, any condition. No repairs, no cleanup,
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/northampton-ma/fire-damage"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Selling a Fire-Damaged Property in Northampton MA
          </h2>
          <p className="text-gray-700 mb-4">
            ...
            Northampton homeowners, the restoration cost — especially on older colonial and New
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Fire-Damaged Home Sales in Northampton MA" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell Your Fire-Damaged Northampton MA Property?"
          sourcePage="/markets/northampton-ma/fire-damage"
        />
      </div>
    </>
