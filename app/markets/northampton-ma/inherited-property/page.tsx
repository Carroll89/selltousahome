...
const pageUrl = `${SITE_URL}/markets/northampton-ma/inherited-property`;

export const metadata: Metadata = {
  title: 'Sell Inherited House Northampton MA — Estate Sales Hampshire County',
  description:
    'Inherited a house in Northampton MA? We buy inherited properties through Hampshire County Probate Division — cash offer in 24 hours, close as-is after Letters of Administration issued.',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Yes. Many heirs sell Northampton MA properties remotely. We coordinate with the estate attorney, handle the Hampshire County process, and the executor can often sign closing documents via remote notarization or by traveling once for signing. Call 888-274-5006 to discuss your specific timeline.",
  },
];

const LINKS = [
  { href: '/markets/northampton-ma/probate', label: 'Probate Sale' },
...
export default function NorthamptonInheritedPropertyPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          northamptonLocalBusinessSchema,
          articleSchema('Sell Inherited House in Northampton MA', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell an Inherited House in Northampton MA — Hampshire County Estate Sale
            </h1>
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/northampton-ma/inherited-property"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Why Northampton Has Many Inherited Properties
          </h2>
          ...
          <p className="text-gray-700 mb-4">
            Out-of-state heirs are common. Adult children who grew up in Northampton and moved to
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            ...
            <p className="text-sm text-blue-700 mt-1">
              ...
              rather than waiting idle during the Hampshire County probate process. Call
              888-274-5006 to walk through your timeline.
            </p>
          </div>
        </section>

        <FAQSection items={FAQ_ITEMS} heading="FAQs — Inherited Property in Northampton MA" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell an Inherited Northampton MA Property?"
          sourcePage="/markets/northampton-ma/inherited-property"
        />
      </div>
    </>
