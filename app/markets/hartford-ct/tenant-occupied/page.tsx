...
const FAQ_ITEMS = [
  {
    ...
    answer: 'No. We buy properties with tenants in place — paying or non-paying. Connecticut summary-process cases require statutory notices and court filings, so timing varies by case and docket. A direct cash sale lets you sell without completing an eviction first.',
  },
  {
    question: 'How does Connecticut eviction affect the sale timeline?',
    answer: 'According to Connecticut summary-process statutes, eviction generally starts with a Notice to Quit followed by a summary-process action in Housing Court. Hartford timing depends on service, filings, defenses, mediation, and court scheduling. We avoid that delay by purchasing with tenants in place.',
  },
  {
  ...
  },
  {
    ...
    answer: 'That depends on the property and the tenants. Under Connecticut landlord-tenant law, existing lease and notice obligations still matter after a sale. Our approach varies by situation — sometimes tenants stay, sometimes we work with them on a transition.',
  },
];
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">Tired of being a landlord in Hartford? USA Home Buyers purchases tenant-occupied properties for cash — tenants in place, no eviction required before sale. Written offer in 24 hours. Close in 7-14 days when title is clear. We handle the tenant situation after closing under applicable Connecticut landlord-tenant rules. Call 888-274-5006.</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Hartford has a high percentage of renter-occupied housing, according to Census-style housing-occupancy datasets. That means a lot of landlords, and a lot of landlord fatigue. Between Housing Court timing, aging multi-family housing stock, and tenants who stop paying, the math can stop working.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700">
            Per Connecticut summary-process law, eviction generally requires a Notice to Quit followed by a Housing Court case. Hartford timing varies by case and docket. A direct cash sale to us can close in 7-14 days when title is clear — you're out of the landlord business without filing an eviction first.
          </p>
        </section>
