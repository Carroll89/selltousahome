...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/york-pa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "York PA historic row homes — Sell Your House Fast for Cash",
      },
    ],
  },
};
...
const TESTIMONIALS = [
  {
    quote:
      "My grandfather built that row home on East Market Street in 1952. After he passed, I inherited a property with a bad roof, outdated wiring, and a tenant who hadn't paid in months. I'm in New Jersey — managing a York property remotely was killing me. USA Home Buyers made a written offer in under 24 hours and closed in 9 days. I left the furniture.",
    name: "Marcus T.",
  ...
  {
    quote:
      "Received an Act 91 notice in January. I had no idea I had maybe six months before a sheriff sale. USA Home Buyers explained everything — the timeline, the options — and had a written offer the next morning. We closed before any court filings. I walked away with $41,000 instead of nothing.",
    name: "Denise H.",
  ...
  {
    quote:
      "Divorce settlement required the house on King Street to be sold. My ex and I couldn't even be in the same room. USA Home Buyers handled everything through our attorneys. One number, one closing, proceeds split the day we signed.",
    name: "Carlos R.",
  ...
  {
    quote:
      "WellSpan transferred me to their Chambersburg facility and I needed to be there in four weeks. My West York house was in good shape but I couldn't be in two places at once for a traditional sale. USA Home Buyers had a written offer the same morning I called. Closed in eight days. I made it to Chambersburg before my start date.",
    name: "Aaron W.",
  ...
  {
    quote:
      "We'd been in our Springettsbury Township house for thirty-four years. Property taxes, big yard, too many rooms. Phil had a health scare and we both decided it was time to simplify. USA Home Buyers made us a fair offer and closed in seven days. We're in a condo in York with a lot less to worry about.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    traditional: "Usually required ($8K-$20K avg)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$8,300-$9,900 on $165K home)",
  },
  {
    label: "Transfer tax (2%)",
    cashBuyer: "We cover all closing costs",
    traditional: "Seller pays ~1% local portion ($1,650)",
  },
  {
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Once you accept a written offer, we close in 7-14 days. We send the written offer within 24 hours of your inquiry. According to Redfin city housing-market data (March 2026), York homes show 27 median days on market — that path requires showings, inspections, and waiting on mortgage lender approval. With a cash sale, there's no bank involved, no contingency period, no repair demands.",
  },
  {
    question: "What is the transfer tax when selling in York PA?",
    answer:
      "York PA has a 2% total real estate transfer tax — 1% Commonwealth of Pennsylvania plus 1% local (0.5% City of York + 0.5% York City School District, per Article 355 of York City Codified Ordinances). By convention, buyer and seller each pay 1%. On a $165,000 home, the total is $3,300 — seller's share is $1,650. When you sell to us, we cover all closing costs including the full transfer tax. Source: PA Dept. of Revenue (pa.gov); City of York (yorkcity.org).",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. York City's housing stock is predominantly pre-1940 brick row homes — built for factory workers in the late 1800s and early 1900s. According to the U.S. Census Bureau ACS, York's median housing age skews heavily pre-1960, with widespread deferred maintenance, aging systems, and structural wear. That's exactly what we buy every week.",
  },
  {
    question: "What neighborhoods in York do you buy in?",
    answer:
      "All of York City and York County — Downtown, Northeast York, Southwest York, Springdale, East Side, and surrounding areas. We also serve Hanover, Red Lion, Dallastown, Spring Grove, Dover, Shrewsbury, New Freedom, Glen Rock, Dillsburg, Manchester, Windsor, Seven Valleys, Jacobus, West York, North York, Wrightsville, and Mount Wolf.",
  },
  {
    question:
      "¿Compran casas en York PA? / Do you work with Spanish-speaking sellers?",
    answer:
      "Sí, hablamos español. According to the U.S. Census Bureau ACS, 36.6% of York City residents are Hispanic or Latino — the second-highest of any market we serve. We serve the York community in both English and Spanish. Call us, fill out the form, or stop by. Entendemos el vecindario y el proceso.",
  },
  {
    question: "Is USA Home Buyers a legitimate company?",
    answer:
      "We're a Pennsylvania LLC. Every offer is in writing — a formal purchase agreement with price, terms, and closing date. No verbal promises. You can verify our Pennsylvania business registration at corporations.pa.gov. We've closed sales throughout York County.",
  },
  {
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              York cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your York house in any condition — no
              repairs, no cleaning, no agent fees.
            </p>
          </div>
          ...
          <div className="order-3 lg:col-start-1 lg:row-start-2">
            <p className="hidden lg:block text-base md:text-lg text-blue-100 mb-4">
              Get a written cash offer for your York house in any condition — no
              repairs, no cleaning, no agent fees. Written offer within 24
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for York homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the York section for local market data, situation pages,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="my-10 bg-blue-50 border-l-4 border-brand-primary rounded-r-2xl p-6 md:p-8">
          <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-3">
            York PA: America's First Capital, Industrial Heritage, and a Housing
            Market That Moves Fast
          </h2>
          <p className="text-gray-700 mb-4">
            York isn't just another Pennsylvania city. From September 1777 to
            June 1778, York served as the temporary capital of the Continental
            Congress — where the Articles of Confederation were drafted and
            adopted. That history is written into the city's bones: Federal and
            Colonial row homes dating to the 1700s line the downtown streets,
            some of the oldest residential structures in the Mid-Atlantic.
          </p>
          <p className="text-gray-700 mb-4">
            York also carries an industrial legacy — York Barbell, York
            International, and the manufacturing belt that powered South Central
            Pennsylvania through the 20th century. The worker housing from that
            era dominates the Northeast York and Southwest York neighborhoods:
            attached red brick row homes built between 1890 and 1930, tight
            lots, concrete stoops, and decades of deferred maintenance.
            According to the{" "}
            <a
              href="https://datausa.io/profile/geo/york-pa"
              className="text-brand-primary hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              U.S. Census Bureau ACS via DataUSA
            </a>
            , York City's homeownership rate is just 43.7% — meaning over half
            the city rents, and many owner-occupied properties are held by aging
            or distressed sellers who need a fast, certain exit.
          </p>
            ...
            {[
              {
                ...
                value: "84/100",
                note: "Very Competitive — Redfin city, Mar 2026",
              },
              {
                label: "Hispanic residents",
                value: "36.6%",
                note: "Second-highest of any market we serve — ACS 2024",
              },
              {
                label: "City median sale price",
                value: "$172,500",
                note: "Redfin city, -2.5% YoY (Mar 2026)",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <p className="text-gray-700 text-sm">
            Unlike Lancaster or Bethlehem, York has no major iBuyer presence.
            According to our competitor research, Opendoor and Offerpad do not
            actively make offers in York PA due to city size. Sellers in York
            who want speed have fewer credible options — which is exactly where
            we step in.
          </p>
        </section>
        ...
        <section className="my-10 bg-brand-light rounded-2xl p-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <tbody>
                {[
                  [
                    "City median home value (Zillow Research ZHVI, 2026-03-31)",
                    "$275,648",
                  ],
                  ["YoY change — city area (Zillow)", "+4.0%"],
                  [
                    "York County median home value (Zillow Research, 2026-03-31)",
                    "$305,195",
                  ],
                  ["York County YoY change (Zillow)", "+3.7%"],
                  [
                    "Median sale price — York City (Redfin city, Mar 2026)",
                    "$172,500",
                  ],
                  ["YoY change — city sale price (Redfin)", "-2.5%"],
                  [
                    "ACS median property value (city residents, 2024)",
                    "$119,700",
                  ],
                  ...
                  [
                    "Transfer tax",
                    "2% total (1% PA state + 0.5% City of York + 0.5% York City School District)",
                  ],
                  [
          ...
          <p className="mt-4 text-xs text-gray-400">
            Provider data: Redfin city March 2026; Zillow Research city/county
            ZHVI 2026-03-31
          </p>
          <p className="mt-2 text-sm text-gray-600">
            York City's $172,500 median sale price is 59% lower than the
            national average according to Redfin — making it one of the most
            accessible cash buyer markets in Pennsylvania. But "accessible" cuts
            both ways: aging housing stock, high investor activity in Northeast
            York, and a 21.1% poverty rate mean many sellers are in situations
            where certainty matters more than squeezing every dollar from a
            retail listing.
          </p>
          <p className="mt-2 text-sm">
            <Link
              href="/markets/york-pa/market-report"
              className="text-brand-primary hover:underline"
            >
        ...
        <section className="my-10 bg-green-50 border border-green-200 rounded-2xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-3">
            According to the U.S. Census Bureau ACS, 36.6% of York City
            residents are Hispanic or Latino — the second-highest concentration
            of any market we serve. York's Spanish-speaking community, primarily
            from Puerto Rico, the Dominican Republic, and Mexico, has been woven
            into this city for generations. Many families own the row homes in
            Northeast and Southwest York.
          </p>
          <p className="text-gray-700 mb-4">
            Compramos casas en York, PA. Si necesita vender su casa rápido — sin
            reparaciones, sin agentes, sin complicaciones — llámenos. Ofrecemos
            una oferta en efectivo en 24 horas y cerramos en 7 días. Hablamos
            español y entendemos su situación. No competitors in York appear to
            offer Spanish-language service.
          </p>
          <a
            href={`tel:${PHONE}`}
          ...
          situations={[
            {
              ...
              href: "/markets/york-pa/inherited-property",
              description:
                "Sell an inherited York row home through the York County Register of Wills process",
            },
            {
              label: "Going Through Divorce",
              href: "/markets/york-pa/divorce-sale",
              description:
                "Close quickly, split proceeds cleanly — one offer, one closing",
            },
            {
              label: "Facing Foreclosure",
              href: "/markets/york-pa/foreclosure",
              description:
                "York County foreclosure timeline is ~270 days — sell now, protect your equity",
            },
            {
              label: "Probate Sale",
              href: "/markets/york-pa/probate",
              description:
                "We work with York County Register of Wills and estate executors regularly",
            },
            {
              label: "Tenant-Occupied Property",
              href: "/markets/york-pa/tenant-occupied",
              description:
                "We buy with tenants still in place — no eviction required",
            },
            {
              label: "Code Violations",
              href: "/markets/york-pa/code-violations",
              description:
                "Open permits, failed inspections, condemned properties — we buy anyway",
            },
            {
              label: "Fire Damage",
              href: "/markets/york-pa/fire-damage",
              description:
        ...
        <TestimonialBlock
          ...
          heading="What York PA Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            On a $172,500 York City home, a 5-6% agent commission is
            $8,625-$10,350. Add inspection repairs on a pre-1940 Northeast York
            row home, 27 days of carrying costs, and transfer tax — the real gap
            between a cash offer and a traditional listing is much narrower than
            sellers expect, and the certainty of a cash close is incomparable.
          </p>
        </section>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your York PA Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our primary market is York City — Downtown, Northeast York,
            Southwest York, Springdale, East Side, and the historic districts
            near Continental Square. We know these streets: the dense row home
            blocks off East Market Street, the Colonials near Penn Park, the
            worker cottages in Fairmount.
          </p>
          <p className="text-gray-700 mb-4">
            We also serve all of York County. York is the county seat of a
            909-square-mile county. From our York City base, we reach Hanover
            (~22 miles southwest), Red Lion (~10 miles southeast), Shrewsbury
            (~18 miles south), and Dillsburg (~18 miles northwest). If you're in
            a rural York County township with a farmhouse that's been in the
            family for generations — we handle those estate situations too.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            York PA Neighborhoods We Serve
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            From Downtown Colonial-era properties to Northeast York row homes —
            we buy in every York City neighborhood and township.
          </p>
          <Link
            href="/markets/york-pa/neighborhoods"
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your York PA Home?"
            sourcePage="/markets/york-pa"
          />
        </section>
      </div>
