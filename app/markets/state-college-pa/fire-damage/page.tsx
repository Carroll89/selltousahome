  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a Fire-Damaged House in State College PA',
          description:
            'No restoration required — we buy fire-damaged homes as-is',
          contentUrl: `${SITE_URL}/videos/state-college-fire-damage.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/state-college-fire-damage-poster.jpg`,
