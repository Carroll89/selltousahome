  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling Probate Property in State College PA',
          description:
            'Working with executors and Centre County Register of Wills',
          contentUrl: `${SITE_URL}/videos/state-college-probate.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/state-college-probate-poster.jpg`,
