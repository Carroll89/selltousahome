...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/state-college-pa-representative-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Representative State College PA residential homes — Sell Your House Fast for Cash",
      },
    ],
  },
};
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "The basement had taken water twice from spring flooding near Spring Creek. Second time, the water heater and furnace were a complete loss and there was mold behind the drywall in two corners. The remediation quote was $26,000. I decided to sell instead. USA Home Buyers closed in twelve days.",
    name: "Phil K.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "None — buy as-is",
    traditional: "Usually required ($8K-$25K avg)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$22,500-$27,000 on median)",
  },
  {
    label: "Transfer tax (State College Borough)",
    cashBuyer: "We cover everything",
    traditional: "3.00% total — $14,415 on $480,500 sale",
  },
  {
    label: "Sale certainty",
    cashBuyer: "Guaranteed written contract",
    traditional: "15-20% fall-through rate",
  },
  {
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              State College cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your State College house in any
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              State College mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for State College homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the State College section for local market data, situation
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/state-college-pa/resources"
            ...
            <Link
              href="/guides/sell-house-fast-state-college-pa-2026"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="my-10 bg-blue-50 border-l-4 border-brand-primary rounded-r-2xl p-6 md:p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            USA Home Buyers purchases houses in State College, PA for cash —
            as-is, in any condition, with no repairs and no agent fees.
            According to the Zillow Home Value Index, the State College median
            home value is $408,500 (March 2026, +0.9% year-over-year); Redfin's
            median closed sale price is $480,500 with a Compete Score of 91/100
            — among the most competitive in Pennsylvania. Homes go pending in 5
            days on average. We close in 7–14 days, no inspections or financing
        ...
        <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
          ...
          <div className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
            <p className="mb-3">
              If you&apos;re trying to sell a house in State College, there are
              a few things about this market that most sellers don&apos;t find
              out until it&apos;s too late. I&apos;m with USA Home Buyers, and
              we buy houses here in Centre County for cash — fast, as-is, no
              games.
            </p>
            <p className="mb-3">
              First thing to know: State College Borough has a 3% realty
              transfer tax — not the standard 2% you&apos;d see in most of
              Pennsylvania. On a $400,000 sale that&apos;s $12,000 in transfer
              taxes versus $8,000 a few miles away in a township. We cover that
              when we buy your home. You don&apos;t pay it.
            </p>
            <p className="mb-3">
              Second: this is one of the most renter-heavy markets in
              Pennsylvania. Nearly 74% of housing units are rentals — which
              means there are a lot of landlords who are tired of the annual
              Penn State lease cycle: find tenants in the spring, deal with
              move-out damage in May, start over. If that&apos;s your situation,
              we buy rental properties with tenants in place.
            </p>
            <p className="mb-3">
              Third: the dominant housing stock here is 1970s and 1980s
              split-levels and colonials. Great bones, but they need updating.
              Traditional buyers will come in with inspectors and repair
              demands. We don&apos;t. We buy as-is.
            </p>
            <p className="mb-3">
              The process is simple. You call us or fill out the form. We get
              back to you within hours, ask about 10 questions about the
              property, and give you a written cash offer within 24 hours. If
              you accept, we set a closing date — as fast as seven days, or
              whenever works for you.
            </p>
            <p className="mb-3">
              We serve all of Centre County: State College Borough, Bellefonte,
              Boalsburg, Ferguson Township, Patton Township, Port Matilda, and
              beyond. Call USA Home Buyers at 888-274-5006.
            </p>
          </div>
        </details>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Common Questions from State College Sellers"
        />
        ...
        <section className="my-12 bg-brand-light rounded-2xl p-8">
          ...
          <p className="text-gray-600 text-sm mb-6">
            According to Redfin city (March 2026) and Zillow Research City ZHVI
            CSV (2026-03-31), State College is one of Pennsylvania&apos;s most
            competitive markets — a 91/100 Redfin Compete Score with homes going
            pending in 5 days.
          </p>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [
                    "Typical cash offer range (ZHVI basis)",
                    "$286,000–$327,000",
                  ],
                  [
                    "Transfer tax — State College Borough",
                    "3.00% total (vs. 2.00% in most Centre County townships)",
                  ],
                  [
                    "Owner-occupied housing",
                    "26.1% — small, motivated seller pool",
                  ],
                  [
                    "Renter-occupied housing",
                    "73.9% — large landlord exit opportunity",
                  ],
                ].map(([metric, value], i) => (
                  <tr
                    key={i}
          ...
          <p className="mt-4 text-sm text-gray-600">
            The 5-day DOM looks fast, but homes that need work, carry lease
            complications, or sit in estate situations don&apos;t move the same
            way as retail-ready properties. That&apos;s where we come in.
          </p>
          <p className="mt-2 text-sm">
            <Link
              href="/markets/state-college-pa/market-report"
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Penn State University Park enrolls over 46,000 students and employs
            roughly 17,000 people. That creates a real estate market unlike
            anywhere else in Central Pennsylvania.
          </p>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 text-sm">
            ...
            <span className="text-amber-900">
              State College Borough charges 3.00% total realty transfer tax —
              the highest in Centre County. That&apos;s $14,415 on a $480,500
              sale. When you sell to us, we cover the full transfer tax. Source:{" "}
              <a
                href="https://centrecountypa.gov/420/Realty-Transfer-Tax-Rates"
                target="_blank"
        ...
        <TestimonialBlock
          ...
          heading="What Centre County Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            State College&apos;s 91/100 Compete Score means retail-ready homes
            do well on the MLS. But factor in the 3% transfer tax, agent
            commissions, repairs on older 1970s stock, and carrying costs during
            a 60-day escrow — and the gap between cash and traditional narrows
            significantly.
          </p>
          <p className="mt-2 text-sm">
            <Link
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our core market is State College Borough and the surrounding
            townships — Ferguson Township, Patton Township, College Township,
            Harris Township (Boalsburg). We know the difference between a
            Highlands split-level and a College Heights colonial, and we price
            accordingly.
          </p>
          <p className="text-gray-700 mb-4">
            We also buy throughout Centre County: Bellefonte (the county seat),
            Port Matilda, Milesburg, Philipsburg, Snow Shoe, and the rural
            boroughs along PA Route 26 and I-99. Into Blair County toward
            Tyrone, Clinton County toward Lock Haven, and Mifflin County toward
            Lewistown.
          </p>
        ...
        <section className="my-12">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Answer 4 quick questions and get a cash offer for your State
              College home.
            </p>
          </div>
