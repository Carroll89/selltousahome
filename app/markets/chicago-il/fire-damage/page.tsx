...
const pageUrl = `${SITE_URL}/markets/chicago-il/fire-damage`;

export const metadata: Metadata = {
  title: 'Fire Damage Help in Chicago IL — Sell As-Is for Cash',
  description: 'Fire or smoke damage does not have to be repaired before a cash offer. We evaluate the property as-is and explain the offer before you commit. USA Home Buyers buys Chicago IL houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with fire damage in Chicago IL?', answer: 'Yes. We buy Chicago IL houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
