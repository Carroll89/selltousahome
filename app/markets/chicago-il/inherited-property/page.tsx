...
const pageUrl = `${SITE_URL}/markets/chicago-il/inherited-property`;

export const metadata: Metadata = {
  title: 'Inherited Property Help in Chicago IL — Sell As-Is for Cash',
  description: 'Inherited houses often involve out-of-state heirs, cleanout problems, deferred repairs, and estate authority questions. USA Home Buyers buys Chicago IL houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with inherited property in Chicago IL?', answer: 'Yes. We buy Chicago IL houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
