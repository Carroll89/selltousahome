...
const pageUrl = `${SITE_URL}/markets/chicago-il/probate`;

export const metadata: Metadata = {
  title: 'Probate Help in Chicago IL — Sell As-Is for Cash',
  description: 'Probate and estate-title issues do not automatically block an offer. The title company and estate professionals confirm who has authority to sign before closing. USA Home Buyers buys Chicago IL houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with probate in Chicago IL?', answer: 'Yes. We buy Chicago IL houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
