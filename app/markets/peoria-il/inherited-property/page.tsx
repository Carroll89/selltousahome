  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell Inherited House in Peoria IL',
          description: 'We work with Peoria County probate timelines — as-is, any condition',
          contentUrl: `${SITE_URL}/videos/peoria-il/inherited-property.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/peoria-il/inherited-property-poster.jpg`,
        }),
      ]} />
