...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/peoria-il-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Peoria IL home — Sell Your House Fast for Cash",
      },
    ],
  },
};
...
const peoriaILLocalBusinessSchema = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 40.6936, longitude: -89.589 },
  areaServed: [
    {
      "@type": "City",
      name: "Peoria",
      sameAs: "https://en.wikipedia.org/wiki/Peoria,_Illinois",
    },
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "7-14 days",
    traditional: "44-59 days (DOM + 30-45 close)",
  },
  {
    label: "Repairs required",
    cashBuyer: "None — we buy as-is",
    traditional: "Usually required ($5K-$20K on pre-1940 stock)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$7,000-$8,400 on Peoria median)",
  },
  {
    label: "IL + County + City transfer tax",
...
export default function PeoriaILMarketPage() {
  const howToSchema = {
    ...
    description:
      "Step-by-step process for selling your Peoria or Peoria County home for cash",
    step: [
      {
        "@type": "HowToStep",
        name: "Submit Your Property Info",
        text: "Fill out our 2-minute form with your Peoria or Peoria County property address, condition, and timeline.",
        position: 1,
      },
      {
        "@type": "HowToStep",
      ...
      },
      {
        ...
        text: "Sign at a Peoria title company of your choice, walk away with your cash. No repairs, no cleanout.",
        position: 4,
      },
    ],
  };
  ...
  return (
    <>
      <SchemaMarkup
        schema={[
          peoriaILLocalBusinessSchema,
          faqSchema(FAQ_ITEMS),
          howToSchema,
          videoObjectSchema({
            name: "Sell My House Fast Peoria IL — USA Home Buyers",
            description:
              "Cash offers for Peoria and Peoria County homes — any condition",
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Peoria cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Peoria house in any condition —
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Peoria homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Peoria section for local market data, situation pages,
              seller guides, and articles before you decide whether a cash offer
              or listing makes more sense.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/peoria-il/resources"
              className="bg-brand-primary hover:bg-blue-700 text-white font-semibold rounded-lg px-5 py-3 text-center transition-colors"
            >
              Peoria Resources
            </Link>
            <Link
              href="/guides/sell-house-fast-peoria-il-2026"
      ...
      <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
        ...
        <div className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
          Need to sell your house fast in Peoria, Illinois? USA Home Buyers
          purchases homes as-is for cash throughout Peoria County. No agents, no
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Peoria is the county seat of Peoria County and the largest city on
            the Illinois River, with a population of 112,169 (2024 ACS
            estimate). Once the largest city in Illinois in the mid-20th
            century, Peoria's economy pivoted from heavy Caterpillar-anchored
            manufacturing toward a healthcare-education-logistics hybrid — a
            transition that shaped both the city's demographics and its housing
            market in ways that directly affect sellers today.
          </p>
          <p className="text-gray-700 mb-4">
            According to the Zillow Research City ZHVI CSV (Peoria city,
            2026-03-31), Peoria's Home Value Index is $128,838 — among the
            lowest for any major Illinois metro, and less than half the
            statewide ZHVI of $282,909. Per Redfin (Peoria city, Mar 2026), the
            median sale price for Peoria city is $145,900, up 8.2%
            year-over-year despite a city population decline of approximately
            1.2% since 2019. That combination — rising values despite population
            contraction — reflects strong investor and cash-buyer demand for
            Peoria's entry-level inventory.
          </p>
          <p className="text-gray-700 mb-4">
            The housing stock itself defines the market. Source:
            biggestuscities.com confirms that 24.3% of all Peoria housing units
            were built before 1940 — the highest percentage of any of the three
            Illinois markets in USA Home Buyers' portfolio. South Peoria, East
            Bluff, and the Manual area contain the densest concentrations of
            pre-war balloon-frame construction: 1910s–1930s workers' bungalows
            and two-stories originally built for Caterpillar and industrial
            employees. Many of these homes have deferred $60,000–$100,000 in
            maintenance over decades. They don't qualify for FHA or conventional
            financing. They need a cash buyer.
          </p>
          <p className="text-gray-700 mb-4">
            The Caterpillar HQ departure in 2017 — when Caterpillar moved its
            global headquarters from Peoria to Deerfield (a Chicago suburb) —
            removed a class of high-income executive buyers from the $300,000+
            market segment. Caterpillar's manufacturing and engineering
            operations remain substantial in the Peoria area, but the executive
            professional housing demand that once supported above-$200K prices
            has softened. The cash-buyer opportunity is concentrated in the
            $30,000–$150,000 range where entry-level homes, distressed
            properties, probate estates, and pre-foreclosure acquisitions
            cluster.
          </p>
          <p className="text-gray-700 mb-4">
            OSF HealthCare (OSF Saint Francis Medical Center) and UnityPoint
            Health (Methodist Medical Center of Illinois) are now among the
            largest employers in the Peoria metro, alongside Bradley University.
            Healthcare worker demand supports a middle-market rental and
            entry-to-mid homeownership segment in the Kellar Heights and
            Knoxville Avenue corridor neighborhoods. For sellers, the presence
            of a stable healthcare employment base means motivated buyers exist
            — but so does a large inventory of competing distressed properties.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="bg-white">
                  ...
                  <td className="p-3">$128,838 (+7.4% YoY)</td>
                ...
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                    Redfin Median Sale Price (city)
                  </td>
                  <td className="p-3">$145,900 (+8.2% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Redfin Peoria city, Mar 2026
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    FRED/Realtor CBSA median listing price
                  </td>
                  <td className="p-3">$177,450</td>
                  <td className="p-3 text-gray-500">
                    FRED/Realtor Peoria CBSA, 2026-03-01
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                    Redfin price per square foot
                  </td>
                  <td className="p-3">$92/sq ft (+7.6% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Redfin Peoria city, Mar 2026
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    Redfin sold DOM / FRED active-listing DOM
                  </td>
                  <td className="p-3">
                    25 sold days / 43.00 active-listing days
                  </td>
                  <td className="p-3 text-gray-500">
                    Redfin Peoria city Mar 2026; FRED/Realtor Peoria CBSA,
                    2026-03-01
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Pre-1940 Housing Stock</td>
                  <td className="p-3">24.3%</td>
                  <td className="p-3 text-gray-500">biggestuscities.com</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">RDC Hotness Rank</td>
                  <td className="p-3">#29 (Peoria MSA)</td>
                  <td className="p-3 text-gray-500">Realtor.com</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                    Transfer Tax (state + county + city)
                  </td>
                  <td className="p-3">$800 total on $200K sale (0.40%)</td>
                  <td className="p-3 text-gray-500">
                    35 ILCS 200/31-10; Peoria City Code §27-226
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Foreclosure type</td>
                  <td className="p-3">
                    Judicial — 735 ILCS 5/15-1101 (12-18 mos typical)
                  </td>
                  <td className="p-3 text-gray-500">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">
                    Peoria County Circuit Court, 324 Main St., 309-672-6000
                  </td>
                  <td className="p-3 text-gray-500">10th Judicial Circuit</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Population (city)</td>
                  <td className="p-3">112,169 (declining trend)</td>
                  <td className="p-3 text-gray-500">2024 ACS Estimate</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-600 italic">
            What this means for Peoria sellers: Redfin city sold DOM is 25 days
            while CBSA active-listing DOM is 43.00 days; the large volume of
            distressed inventory and the three-layer transfer tax create
            friction for conventional buyers. On a $145,900 city median home, a
            5-6% agent commission runs $7,295-$8,754 before closing costs, the
            $800 transfer tax stack, and repair requests. At $128,838 ZHVI
            average, those costs represent a significant share of the sale
            price.
          </p>
        </section>
        ...
        <section className="my-12 bg-amber-50 border border-amber-200 rounded-2xl p-6">
          ...
          <p className="text-gray-700 mb-3">
            Peoria City is one of only a handful of downstate Illinois cities
            with a confirmed municipal real estate transfer tax. On a $200,000
            sale, sellers pay $800 total: $200 to the state, $100 to Peoria
            County, and $500 to the City of Peoria (at $2.50/$1,000, effective
            March 4, 2025, per Peoria City Code Article X, Section 27-226). The
            city stamp must be purchased at Peoria City Hall, 419 Fulton St. The
            state and county stamps are purchased separately at the Peoria
            County Clerk's office, 324 Main St. When you sell to USA Home
            Buyers, we cover all three layers — you pay zero at closing.
          </p>
          <Link
            href="/markets/peoria-il/market-report"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            Full transfer tax breakdown in Peoria market report →
          </Link>
        </section>
          ...
          situations={[
            {
              ...
              href: "/markets/peoria-il/inherited-property",
              description:
        ...
        <TestimonialBlock
          ...
          heading="What Peoria IL Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            On the $145,900 Peoria city median, a 5-6% agent commission runs
            $7,295-$8,754. Add Peoria's three-layer transfer tax ($800 on a
            $200K sale), carrying costs during marketing, and repair requests on
            24.3% pre-1940 housing stock. Balloon-frame construction,
            knob-and-tube wiring, and galvanized plumbing are common in South
            Peoria and East Bluff homes — exactly the conditions that flag FHA
            and conventional lenders. A cash offer eliminates the inspection
            contingency and repair negotiation entirely.
          </p>
        </section>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Peoria IL Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our Peoria coverage includes the entire city — Richwoods on the far
            north side with its forest views and top-rated schools, Kellar
            Heights and the Knoxville Avenue corridor where healthcare
            professionals commute to OSF Saint Francis and Methodist Medical,
            Bradley Park and Northmoor near Bradley University's campus with its
            active student rental market, South Peoria and the Manual area with
            the highest concentration of pre-1940 investor-grade inventory, the
            East Bluff neighborhood with its brick bungalows and
            motivated-seller profile, and the historic Grand View Drive corridor
            — the elevated bluff road that Theodore Roosevelt once called the
            world's most beautiful drive, overlooking the Illinois River valley.
          </p>
          <p className="text-gray-700 mb-4">
            We serve the surrounding Peoria County communities — the independent
            village of Peoria Heights (Prospect Road arts district, $126K
            median), Dunlap to the north, Chillicothe, Washington, Morton, and
            all unincorporated Peoria County townships.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          ...
          <p className="text-gray-700 text-sm mb-3">
            From Richwoods ranch homes to South Peoria pre-war bungalows to
            Grand View Drive historic properties — we buy in every Peoria
            neighborhood and every Peoria County community.
          </p>
          <Link
            href="/markets/peoria-il/neighborhoods"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            See Peoria neighborhood-by-neighborhood price ranges →
          </Link>
        </section>
        ...
        <section className="my-8 bg-blue-50 border border-blue-100 rounded-2xl p-6">
          ...
          <p className="text-gray-700 text-sm mb-3">
            Peoria is our third Illinois market, following Springfield and
            Rockford. For statewide Illinois legal context — transfer taxes,
            foreclosure law, probate procedures — see our Illinois state guide.
          </p>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              ...
              your Peoria IL or Peoria County home.
            </p>
          </div>
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Peoria IL Home?"
            sourcePage="/markets/peoria-il"
          />
        </section>
      </div>
