  ...
  return (
    <>
      ...
      <VideoEmbed
        ...
        captionsSrc="/videos/bridgeport-ct/landing-captions.vtt"
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              Bridgeport mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Bridgeport homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Bridgeport section for local market data, situation
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/bridgeport-ct/resources"
            ...
            <Link
              href="/guides/sell-house-fast-bridgeport-ct-2026"
