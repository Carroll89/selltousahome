...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/rockford-il-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Rockford IL home — Sell Your House Fast for Cash",
      },
    ],
  },
};
  ...
  areaServed: [
    {
      "@type": "City",
      name: "Rockford",
      sameAs: "https://en.wikipedia.org/wiki/Rockford,_Illinois",
    },
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "Signal Hill house, divorce situation, both of us needing the proceeds to move forward. Our attorneys kept warning us that contested litigation over the house would drag on for months. We got a single written offer from USA Home Buyers. My ex and I agreed on the number in one phone call — didn't need a judge. Closed three weeks later.",
    name: "Marlene O.",
  ...
  {
    quote:
      "I had a rental on Auburn Street for seven years. The last tenant called the city on me for code violations she had caused herself. I got three notices in six weeks. I wasn't going to fix a property for a tenant who was weaponizing the city against me. USA Home Buyers bought it as-is with the tenant still inside. Eleven days, done.",
    name: "LaShonda B.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "7-14 days",
    traditional: "44-59 days (14 DOM + 30-45 close)",
  },
  {
    label: "Repairs required",
    cashBuyer: "None — we buy as-is",
    traditional: "Usually required ($5K-$20K avg on pre-1970 stock)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$8,500-$10,200 on Rockford median)",
  },
  {
    label: "IL transfer tax (state + county)",
    cashBuyer: "We cover everything",
    traditional: "$0.75/$500 combined — seller pays ~$255 on median",
  },
  {
...
export default function RockfordILMarketPage() {
  const howToSchema = {
    ...
    description:
      "Step-by-step process for selling your Rockford or Winnebago County home for cash",
    step: [
      {
        "@type": "HowToStep",
        name: "Submit Your Property Info",
        text: "Fill out our 2-minute form with your Rockford or Winnebago County property address, condition, and timeline.",
        position: 1,
      },
      {
        "@type": "HowToStep",
        name: "Get Your Written Cash Offer",
      ...
      },
      {
        ...
        text: "Pick any date — as fast as 7 days or whenever works for your schedule.",
        position: 3,
      },
      {
        "@type": "HowToStep",
        name: "Get Paid at Closing",
        text: "Sign at a Rockford IL title company of your choice, walk away with your cash. No repairs, no cleanout.",
        position: 4,
      },
    ],
  };
  ...
  return (
    <>
      <SchemaMarkup
        schema={[
          rockfordILLocalBusinessSchema,
          faqSchema(FAQ_ITEMS),
          howToSchema,
          videoObjectSchema({
            name: "Sell My House Fast Rockford IL — USA Home Buyers",
            description:
              "Cash offers for Rockford and Winnebago County homes — any condition",
            contentUrl: `${SITE_URL}/videos/rockford-il/landing.mp4`,
            thumbnailUrl: `${SITE_URL}/videos/rockford-il/landing-poster.jpg`,
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Rockford cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Rockford house in any condition
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Rockford homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Rockford section for local market data, situation
      ...
      <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
        ...
        <div className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
          If you need to sell your house fast in Rockford, Illinois — you've
          found the right team. We're USA Home Buyers, and we purchase houses
          as-is, for cash, throughout Winnebago County. No agents. No fees. No
          repairs needed. Written cash offer within 24 hours, close in as few as
          seven days. Call us at 888-274-5006.
        </div>
      </details>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Rockford is Illinois's fifth-largest city, Winnebago County's seat,
            and a 147,521-person Rust Belt metro 90 miles west of Chicago.
            Realtor.com ranked Rockford the #11 hottest housing market in the
            country as of March 2026 (hotness score 93.645, median active
            listing days on market 34.5 days) — a number that would surprise
            anyone who remembers Rockford's industrial decline in the 1980s and
            1990s. The recovery is real, and it's driven by a combination of
            factors specific to this market.
          </p>
          <p className="text-gray-700 mb-4">
            Rockford built its economy on precision manufacturing — the city was
            once known as the screw capital of the world, with Illinois Tool
            Works and dozens of fastener, furniture, and machine-tool companies
            employing generations of working-class families. That industrial
            heritage created a distinctive housing stock: pre-war Craftsman
            bungalows in Churchill Grove and Midtown, working-class two-flats
            along West State Street, modest post-war ranches in Signal Hill and
            Jackson Oaks, and Victorian-era homes in the Haight Village Historic
            District dating back to the 1840s. The majority of Rockford's
            residential stock was built before 1970.
          </p>
          <p className="text-gray-700 mb-4">
            That housing stock is what drives the cash-buyer market here.
            Pre-1970 construction frequently carries original knob-and-tube
            wiring, galvanized plumbing, and foundation issues from Rock River
            alluvial soil settling — all red flags for FHA and conventional
            lenders. The Redfin compete score of 90/100 tells you that
            retail-ready homes move fast (median 14 days on market for sold
            homes), but the operative phrase is "retail-ready." Many Rockford
            homes aren't, and those require a cash buyer who doesn't need
            financing contingencies.
          </p>
          <p className="text-gray-700 mb-4">
            The manufacturing closure cycle also creates a steady
            distressed-seller pipeline that's distinct from Springfield's
            government-worker dynamics. When a supplier to the former Chrysler
            FCA plant in adjacent Belvidere closes, or a factory worker on a
            fixed union pension faces a major repair bill on a 1940s bungalow
            they inherited from their parents, the decision to sell for cash
            rather than fund a renovation they can't afford is straightforward.
            USA Home Buyers serves exactly this seller profile.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="bg-white">
                  ...
                  <td className="p-3">$177,225 (+9.9% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Zillow Research City CSV, 2026-03-31
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Redfin Median Sale Price</td>
                  <td className="p-3">$170,000 (+17.2% YoY)</td>
                  <td className="p-3 text-gray-500">Redfin (Mar 2026)</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Price per Square Foot</td>
                  <td className="p-3">$109 (+10.1% YoY)</td>
                  <td className="p-3 text-gray-500">Redfin (Mar 2026)</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                ...
                <tr className="bg-white">
                  <td className="p-3 font-medium">RDC Active Listing DOM</td>
                  <td className="p-3">34.5 days (Rank #11 nationally)</td>
                  <td className="p-3 text-gray-500">Realtor.com (Mar 2026)</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Redfin Compete Score</td>
                  <td className="p-3">90/100 — Very Competitive</td>
                  <td className="p-3 text-gray-500">Redfin (Mar 2026)</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Sale-to-List Ratio</td>
                  <td className="p-3">100.3% (+2.6 pt YoY)</td>
                  <td className="p-3 text-gray-500">Redfin (Mar 2026)</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                    IL Transfer Tax (state + county)
                  </td>
                  <td className="p-3">
                    $0.75 per $500 (0.15%) — seller pays; no municipal RETT
                  </td>
                  <td className="p-3 text-gray-500">
                    35 ILCS 200/31-10; 55 ILCS 5/5-1031
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Foreclosure type</td>
                  <td className="p-3">
                    Judicial — 735 ILCS 5/15-1101 (14-20 mos typical)
                  </td>
                  <td className="p-3 text-gray-500">
                ...
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Probate court</td>
                  <td className="p-3">
                    Winnebago Co. Circuit Court, 400 W State St, 815-319-4500
                  </td>
                  <td className="p-3 text-gray-500">17th Judicial Circuit</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-600 italic">
            What this means for Rockford sellers: the market is genuinely
            competitive — 14-day median DOM means the right retail listing moves
            fast. But older Rockford housing stock frequently doesn't qualify
            for FHA or conventional financing, which narrows the retail buyer
            pool significantly. A 5-6% agent commission on a $170,000 median
            home runs $8,500-$10,200 before closing costs and repair requests.
            On a $177,225 ZHVI home, every dollar saved on commissions and
            repairs is a meaningful portion of the sale price.
          </p>
        </section>
          ...
          situations={[
            {
              ...
              href: "/markets/rockford-il/inherited-property",
              description:
                "Sell an inherited Rockford home — we work with Winnebago County Circuit Court Probate Division timelines",
            },
            {
              label: "Going Through Divorce",
              href: "/markets/rockford-il/divorce-sale",
              description:
                "One offer, one closing — equitable distribution without the delay under 750 ILCS 5/503",
            },
            {
              label: "Facing Foreclosure",
              href: "/markets/rockford-il/foreclosure",
              description:
                "IL judicial foreclosure (735 ILCS 5/15-1101) — sell before the Winnebago County auction",
            },
            {
              label: "Probate Sale",
              href: "/markets/rockford-il/probate",
              description:
                "We work with Winnebago County Circuit Court Probate Division cases, independent and supervised administration",
            },
            {
              label: "Tenant-Occupied Property",
              href: "/markets/rockford-il/tenant-occupied",
              description:
                "We buy with tenants in place — no eviction required before closing in Illinois",
            },
            {
              label: "Code Violations",
              href: "/markets/rockford-il/code-violations",
              description:
                "City of Rockford open violations, condemned properties — we buy anyway, as-is",
            },
            {
              label: "Fire Damage",
              href: "/markets/rockford-il/fire-damage",
              description:
                "Fire or smoke damage in Rockford? We purchase as-is with no cleanup required",
            },
          ]}
        />
        <TestimonialBlock
          testimonials={TESTIMONIALS}
          heading="What Rockford IL Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            On a $170,000 Rockford home, a 5-6% agent commission runs
            $8,500-$10,200. Add Illinois's combined transfer tax (~$255),
            carrying costs during 14+ days on market, and repair requests on
            pre-1970 Rust Belt housing stock. Churchill Grove craftsmen and
            Midtown bungalows frequently have deferred-maintenance issues —
            original wiring, galvanized plumbing, Rock River alluvial soil
            foundation settling — that conventional lenders flag and require
            remediation. A cash offer eliminates the inspection contingency and
            repair negotiation entirely. At $177,225 ZHVI average, every dollar
            of commission and repair cost is significant relative to the sale
            price.
          </p>
        </section>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Rockford IL Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our Rockford coverage includes the entire city — downtown Rockford
            and the 61101 ZIP corridor along West State Street, Churchill Grove
            on the northwest side with its tree-lined streets and craftsman
            bungalows, Midtown near the Rock River where pre-war bungalows and
            two-flats are concentrated, Signal Hill and Jackson Oaks on the
            south and southwest sides where post-war ranches dominate, Northeast
            Rockford with its higher-priced colonials and newer construction,
            and the Haight Village Historic District with Victorian and Queen
            Anne homes dating to the 1840s.
          </p>
          <p className="text-gray-700 mb-4">
            We serve the surrounding Winnebago County communities — Loves Park
            (immediately north, pop ~23K), Machesney Park (northwest, pop ~23K),
            Roscoe, Rockton, Cherry Valley, New Milford, Winnebago Village, and
            Pecatonica. We also cover adjacent Boone County (Belvidere) and
            southern Ogle County due to market proximity.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            Rockford IL Neighborhoods We Serve
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            From Churchill Grove craftsmans to Haight Historic District
            Victorians to Signal Hill ranches — we buy in every Rockford
            neighborhood and every Winnebago County community.
          </p>
          <Link
            href="/markets/rockford-il/neighborhoods"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            See Rockford neighborhood-by-neighborhood price ranges →
          </Link>
        </section>

        <section className="my-8 bg-blue-50 border border-blue-100 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            Our Second Illinois Market
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            Rockford is our second Illinois market, following Springfield (#19,
            Sangamon County). For statewide Illinois legal context — transfer
            taxes, foreclosure law, probate procedures — see our Illinois state
            guide. For our Springfield IL operations, see the Springfield market
            page.
          </p>
          <div className="flex gap-4 flex-wrap">
            <Link
              href="/sell-house-fast-illinois"
              className="text-brand-primary hover:underline font-medium text-sm"
            >
              Illinois Seller's Legal Guide →
            </Link>
            <Link
              href="/markets/springfield-il"
              className="text-brand-primary hover:underline font-medium text-sm"
            >
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              ...
              your Rockford IL or Winnebago County home.
            </p>
          </div>
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Rockford IL Home?"
            sourcePage="/markets/rockford-il"
          />
        </section>
      </div>
