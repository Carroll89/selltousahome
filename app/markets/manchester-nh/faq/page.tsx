...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'All of Hillsborough County and surrounding areas including Nashua, Goffstown, Hooksett, Londonderry, Bedford. Call 888-440-5250 if you\'re not sure whether your address is in our coverage area.',
  },
  {
    question: 'Is USA Home Buyers a legitimate company?',
    answer: 'We provide a written purchase agreement with price, terms, and closing date — no verbal promises. We have closed transactions throughout New Hampshire. You can call us at 888-440-5250 to speak with someone directly.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8">
          <p className="text-sm text-blue-900">
            Common questions from Manchester homeowners about selling for cash. If your question isn't here, call 888-440-5250.
          </p>
        </div>
