...
import { manchesterLocalBusinessSchema, faqSchema, videoObjectSchema } from '@/lib/schema';
...
export default function ManchesterNHMarketPage() {
  ...
  return (
    <>
      <SchemaMarkup schema={[manchesterLocalBusinessSchema, faqSchema(FAQ_ITEMS), howToSchema, videoObjectSchema({ name: 'Sell My House Fast Manchester NH — USA Home Buyers', description: 'Cash offers for Manchester and Hillsborough County homes — any condition', contentUrl: `${SITE_URL}/videos/manchester-nh/landing.mp4`, thumbnailUrl: `${SITE_URL}/images/video-posters/manchester-nh-main-poster.jpg`, uploadDate: '2026-04-28' })]} />
      ...
      <VideoEmbed
        ...
        poster="/images/video-posters/manchester-nh-main-poster.jpg"
        />
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Manchester homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Manchester section for local market data, situation
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/manchester-nh/resources"
            ...
            <Link
              href="/guides/sell-house-fast-manchester-nh-2026"
