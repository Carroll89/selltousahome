  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Sell a Rental Property in Champaign-Urbana IL',
          description: 'Done with landlording? We buy tenant-occupied homes as-is in Champaign County',
          contentUrl: `${SITE_URL}/videos/champaign-urbana-il/tenant-occupied.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/champaign-urbana-il/tenant-occupied-poster.jpg`,
        }),
      ]} />
