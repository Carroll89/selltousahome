  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Sell a Fire-Damaged House in Champaign-Urbana IL',
          description: 'No restoration required — we buy fire-damaged homes as-is in Champaign County',
          contentUrl: `${SITE_URL}/videos/champaign-urbana-il/fire-damage.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/champaign-urbana-il/fire-damage-poster.jpg`,
        }),
      ]} />
      ...
      <VideoEmbed
        src="/videos/champaign-urbana-il/fire-damage.mp4"
        title="Sell a Fire-Damaged House in Champaign-Urbana IL"
        poster="/videos/champaign-urbana-il/fire-damage-poster.jpg"
