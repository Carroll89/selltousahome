...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/champaign-urbana-il-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Champaign-Urbana IL home — Sell Your House Fast for Cash",
      },
    ],
  },
};
...
const champaignUrbanaLocalBusinessSchema = {
  ...
  description:
    "Cash home buyers serving Champaign-Urbana IL and Champaign County. We buy houses as-is in any condition — no repairs, no agent fees, close in 7-14 days.",
  ...
  areaServed: [
    {
      "@type": "City",
      name: "Champaign",
      sameAs: "https://en.wikipedia.org/wiki/Champaign,_Illinois",
    },
    {
      "@type": "City",
      name: "Urbana",
      sameAs: "https://en.wikipedia.org/wiki/Urbana,_Illinois",
    },
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "After the property management company I worked for closed, I never got fully caught back up. By the time the Champaign County case was filed, I was six months behind. USA Home Buyers got me a written offer within forty-eight hours and closed in thirteen days before summary judgment. I had $31,000 in equity I almost lost.",
    name: "Darius M.",
  ...
  {
    quote:
      "Tenure-track couple, both of us got offers in different states. We had four weeks to figure out the Champaign house before our start dates. No time for an agent, inspections, back-and-forth. USA Home Buyers had a written offer the next day. We closed in ten days. Made both start dates.",
    name: "Dr. Priya N.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "7-14 days",
    traditional: "~46-59 days (DOM + close)",
  },
  {
    label: "Repairs required",
    cashBuyer: "None — we buy as-is",
    traditional: "Usually required on older C-U stock",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$11,500-$13,800 on county median)",
  },
  {
    label: "IL transfer tax (state + county)",
    cashBuyer: "We cover everything",
    traditional: "$300 on $200K sale (0.15% combined)",
  },
  {
...
export default function ChampaignUrbanaILMarketPage() {
  const howToSchema = {
    ...
    description:
      "Step-by-step process for selling your Champaign or Urbana IL home for cash",
    step: [
      {
        "@type": "HowToStep",
        name: "Submit Your Property Info",
        text: "Fill out our 2-minute form with your Champaign or Urbana property address, condition, and timeline.",
        position: 1,
      },
      {
        "@type": "HowToStep",
      ...
      },
      {
        ...
        text: "Sign at a Champaign County title company of your choice, walk away with your cash. No repairs, no cleanout.",
        position: 4,
      },
    ],
  };
  ...
  return (
    <>
      <SchemaMarkup
        schema={[
          champaignUrbanaLocalBusinessSchema,
          faqSchema(FAQ_ITEMS),
          howToSchema,
          videoObjectSchema({
            name: "Sell My House Fast Champaign-Urbana IL — USA Home Buyers",
            description:
              "Cash offers for Champaign, Urbana, and Champaign County homes — any condition",
            contentUrl: `${SITE_URL}/videos/champaign-urbana-il/landing.mp4`,
            thumbnailUrl: `${SITE_URL}/videos/champaign-urbana-il/landing-poster.jpg`,
          }),
        ]}
      />
      ...
      <section className="relative text-white py-8 md:py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          <source
            ...
            srcSet="/images/optimized/champaign-urbana-il-hero-1200.jpg"
          />
          <source
            media="(min-width: 1080px)"
            srcSet="/images/optimized/champaign-urbana-il-hero-1080.jpg"
          />
          <source
            media="(min-width: 828px)"
            srcSet="/images/optimized/champaign-urbana-il-hero-828.jpg"
          />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Champaign-Urbana cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Champaign-Urbana house in any
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              Champaign-Urbana mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Champaign-Urbana homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Champaign-Urbana section for local market data,
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/champaign-urbana-il/resources"
              className="bg-brand-primary hover:bg-blue-700 text-white font-semibold rounded-lg px-5 py-3 text-center transition-colors"
            >
              Champaign-Urbana Resources
            </Link>
            <Link
              href="/guides/sell-house-fast-champaign-urbana-il-2026"
      ...
      <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
        ...
        <div className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
          Need to sell your house fast in Champaign-Urbana, Illinois? USA Home
          Buyers purchases homes as-is for cash throughout Champaign County. No
          agents, no fees, no repairs. Written cash offer in 24 hours, close in
          7 days. Call 888-274-5006.
        </div>
      </details>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-12">
          <h2 className="text-2xl md:text-3xl font-bold text-brand-dark mb-6">
            Champaign-Urbana IL Real Estate Market — What Sellers Need to Know
            in 2026
          </h2>
          <p className="text-gray-700 mb-4">
            Champaign-Urbana is the most distinctive housing market in downstate
            Illinois. The University of Illinois Urbana-Champaign — 57,000
            students, the state's flagship land-grant university — functions as
            a gravity well around which everything else orbits. According to
            UIUC (illinois.edu), UIUC is the largest employer in Champaign
            County by a wide margin, with 6,000-7,000 faculty and academic staff
            plus thousands of civil service employees. The Research Park on
            Champaign's southwest side adds 3,000+ private-sector tech workers
            from 100+ companies including State Farm's innovation lab, Abbott,
            Caterpillar Digital, and Sandia National Laboratories affiliates.
          </p>
          <p className="text-gray-700 mb-4">
            This creates a housing market with two distinct buyer-seller
            profiles that don't exist anywhere else in Illinois. On one end:
            UIUC faculty selling tenure-era homes to move to new academic
            positions, Research Park tech workers whose funding ended, and
            grad-student couples who finished their PhDs and need to move fast.
            On the other end: tired landlords exiting student-rental portfolios
            in Campustown and Old West Urbana, Urbana working-class homeowners
            facing distress in South Urbana and Dodds Park, and out-of-state
            heirs managing UIUC faculty estates from across the country.
          </p>
          <p className="text-gray-700 mb-4">
            The dual-city geography matters for sellers to understand. Champaign
            and Urbana are separate incorporated cities sharing the UIUC campus
            and a unified housing market. Per Redfin (Mar 2026), Champaign city
            median sale price is $222,500 while Urbana city is $212,000 —
            reflecting fundamentally different housing stocks and demand
            profiles within the same metro. Critically: the county seat is
            Urbana. All probate filings, foreclosure proceedings, deed
            recording, and county-level legal matters go to the Champaign County
            Courthouse at 101 E. Main Street, Urbana IL 61802. Not Champaign.
          </p>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    Metro ZHVI (Champaign-Urbana MSA)
                  </td>
                  <td className="p-3">$229,687 (+6.8% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Zillow Research Metro CSV, 2026-03-31
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Champaign city ZHVI</td>
                  <td className="p-3">$231,273 (+5.7% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Zillow Research City CSV, 2026-03-31
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Urbana city ZHVI</td>
                  <td className="p-3">$199,534 (+7.2% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Zillow Research City CSV, 2026-03-31
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                    Champaign County Median Sale Price
                  </td>
                  <td className="p-3">$228,000 (-3.8% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Redfin Champaign County, Mar 2026
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    Champaign city Median Sale Price
                  </td>
                  <td className="p-3">$222,500 (-2.6% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Redfin Champaign city, Mar 2026
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">RDC Hotness Rank</td>
                  <td className="p-3">#77 nationally (Champaign-Urbana MSA)</td>
                  <td className="p-3 text-gray-500">Realtor.com (2026)</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    FRED/Realtor CBSA Listing Price (Mar 2026)
                  </td>
                  <td className="p-3">$276,675</td>
                  <td className="p-3 text-gray-500">
                    FRED MEDLISPRI16580 / MEDAONMAMSA16580, 2026-03-01
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">
                    Champaign Co. Circuit Court, 101 E. Main St., Urbana IL
                    61802
                  </td>
                  <td className="p-3 text-gray-500">6th Judicial Circuit</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-600 italic">
            What this means for C-U sellers: the market is healthy and modestly
            appreciating. But a significant share of the housing stock —
            UIUC-adjacent homes built in the 1920s-1940s, student rental
            properties in Campustown, Urbana working-class neighborhoods — has
            deferred maintenance or condition issues that conventional lenders
            flag. A 5-6% agent commission on a $228,000 county median runs
            $11,500-$13,800. On lower-priced Urbana stock, that's a meaningful
          ...
          situations={[
            {
              ...
              href: "/markets/champaign-urbana-il/inherited-property",
              description:
                "UIUC faculty estates, out-of-state heirs — we work with Champaign County Circuit Court Probate timelines",
            },
            {
              label: "Going Through Divorce",
              href: "/markets/champaign-urbana-il/divorce-sale",
              description:
                "One offer, one closing — equitable distribution without the delay under 750 ILCS 5/503",
            },
            {
              label: "Facing Foreclosure",
              href: "/markets/champaign-urbana-il/foreclosure",
              description:
                "IL judicial foreclosure (735 ILCS 5/15-1101) — sell before the Champaign County auction",
            },
            {
              label: "Probate Sale",
              href: "/markets/champaign-urbana-il/probate",
              description:
                "We work with Champaign County Circuit Court Probate cases — 101 E. Main St., Urbana",
            },
            {
              label: "Tenant-Occupied Property",
              href: "/markets/champaign-urbana-il/tenant-occupied",
              description:
                "Tired of student-rental turnover? We buy with tenants in place — no eviction required",
            },
            {
              label: "Code Violations",
              href: "/markets/champaign-urbana-il/code-violations",
              description:
                "Champaign or Urbana open violations — separate city codes, we buy anyway",
            },
            {
              label: "Fire Damage",
              href: "/markets/champaign-urbana-il/fire-damage",
              description:
                "Fire or smoke damage in Champaign-Urbana? We purchase as-is, no cleanup required",
            },
          ]}
        />
        <TestimonialBlock
          testimonials={TESTIMONIALS}
          heading="What Champaign-Urbana Homeowners Are Saying"
        />
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Champaign-Urbana Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our Champaign coverage includes the entire city — Campustown and the
            Green Street corridor adjacent to UIUC, Southwest Champaign and the
            Research Park area (Stone Creek, Savoy), Robeson Woods and
            Presidents Neighborhoods in central Champaign, Country Fair and the
            Neil Street corridor on the west side, and Lincolnshire/Pheasant
            Ridge in the northeast.
          </p>
          <p className="text-gray-700 mb-4">
            In Urbana — the county seat where all legal proceedings are filed —
            we cover the University District adjacent to UIUC's east campus, Old
            West Urbana with its pre-war housing stock, Downtown Urbana and
            Lincoln Square, Crystal Lake Park, Dodds Park and South Urbana, and
            the Busey Woods and Carle Hospital corridor.
          </p>
          <p className="text-gray-700 mb-4">
            Beyond the two cities, we serve Savoy, Rantoul, Mahomet, Tolono, St.
            Joseph, Ogden, and all Champaign County communities. Call (888)
            274-5006 if you're unsure whether we serve your address.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            The UIUC Factor — Why This Market Is Different
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            UIUC creates a seasonal motivated-seller window (May-August) as
            departing faculty and finishing PhD students list before the
            academic year starts. The 57,000-student enrollment creates
            sustained rental demand regardless of broader economic cycles.
            Research Park volatility — when startup funding ends or a company is
            acquired — produces the occasional tech-worker motivated seller in
            Savoy and Southwest Champaign.
          </p>
          <Link
            href="/markets/champaign-urbana-il/market-report"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            See full Champaign-Urbana market data report →
          </Link>
        </section>
        ...
        <section className="my-8 bg-blue-50 border border-blue-100 rounded-2xl p-6">
          ...
          <p className="text-gray-700 text-sm mb-3">
            Champaign-Urbana is our third Illinois market, following Springfield
            and Rockford. For statewide Illinois legal context — foreclosure
            law, probate procedures, transfer tax statutes — see our Illinois
            state guide.
          </p>
        ...
        <BlogClusterLinks
          marketSlug="champaign-urbana-il"
          cityName="Champaign-Urbana"
        />
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              ...
              your Champaign-Urbana or Champaign County home.
            </p>
          </div>
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Champaign-Urbana Home?"
            sourcePage="/markets/champaign-urbana-il"
          />
        </section>
      </div>
