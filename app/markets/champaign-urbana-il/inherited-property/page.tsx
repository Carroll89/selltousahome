  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Sell Inherited House in Champaign-Urbana IL',
          description: 'We work with Champaign County probate timelines — as-is, any condition',
          contentUrl: `${SITE_URL}/videos/champaign-urbana-il/inherited-property.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/champaign-urbana-il/inherited-property-poster.jpg`,
        }),
      ]} />
