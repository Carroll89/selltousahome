  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling an Inherited Property in King of Prussia',
          description: 'No cleanout, no repairs — we handle estate situations throughout Montgomery County',
          contentUrl: 'https://v3b.fal.media/files/b/0a95def1/jVsu-IJt22iTOfJVnP7ix_tmp5zzgvczd.mp4',
          thumbnailUrl: `${SITE_URL}/images/video-posters/kop-inherited.jpg`,
        }),
      ]} />
