...
const pageUrl = `${SITE_URL}/markets/norwich-ct/code-violations`;

export const metadata: Metadata = {
  title: 'Sell House With Code Violations Norwich CT — We Buy As-Is',
  description:
    'Have open code violations on your Norwich CT home? USA Home Buyers purchases homes with code violations, open permits, or city notices in New London County — cash offer in 24 hours.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Will you buy my Norwich house with open code violations?',
    answer:
      "Yes. We purchase houses with open Norwich code violations, city notices, or administrative orders as-is. We resolve violations and liens at or after closing — you don't need to fix anything. Call 888-274-5006.",
  },
  {
    question: 'What kinds of code violations are common in Norwich CT homes?',
    answer:
      "Common violations in Norwich's older housing stock include: structural issues (failing foundations, rotted sills, bowing walls), roof and exterior violations, overgrown vegetation, unpermitted additions, plumbing and electrical deficiencies, and habitability issues. Older colonials and cape cods in Norwich's established neighborhoods regularly carry these issues. We've bought properties with all of them.",
  },
  {
    question: 'Can I still sell if the City of Norwich has issued an unsafe-building order?',
    answer:
  ...
  },
  {
    ...
    answer:
      "Municipal liens for code violations attach to the property. At closing, the title company (and required CT attorney) identify all liens; they are resolved from proceeds before you receive your net amount. We price our offer with known violations in mind — no surprises.",
  },
  {
...
export default function NorwichCodeViolationsPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          norwichLocalBusinessSchema,
          articleSchema('Sell House With Code Violations in Norwich CT', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a House With Code Violations in Norwich CT — We Buy As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">
                Open code violations, city notices, or building orders don't prevent a cash sale.
                USA Home Buyers purchases Norwich homes with code issues as-is throughout
                New London County. Written cash offer in 24 hours, close in 7–14 days. We handle
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/norwich-ct/code-violations"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Code Violations in Norwich CT — Why They Happen
          </h2>
          <p className="text-gray-700 mb-4">
            Norwich's housing stock includes many older colonial, cape cod, and Victorian-era homes
            ...
            unpermitted additions, and habitability issues are all common in New London County's
            older housing inventory.
          </p>
          <p className="text-gray-700 mb-4">
            The City of Norwich's code enforcement and building department track these violations.
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Selling With Code Violations in Norwich CT" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell Your Norwich CT Property With Code Violations?"
          sourcePage="/markets/norwich-ct/code-violations"
        />
      </div>
    </>
