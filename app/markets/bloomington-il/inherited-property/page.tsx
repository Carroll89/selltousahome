  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Sell Inherited House in Bloomington IL',
          description: 'We work with McLean County probate timelines — as-is, any condition',
          contentUrl: `${SITE_URL}/videos/bloomington-il/inherited-property.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/bloomington-il/inherited-property-poster.jpg`,
        }),]} />
