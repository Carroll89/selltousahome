...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/bloomington-il-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Bloomington IL home — Sell Your House Fast for Cash",
      },
    ],
  },
};
  ...
  areaServed: [
    {
      "@type": "City",
      name: "Bloomington",
      sameAs: "https://en.wikipedia.org/wiki/Bloomington,_Illinois",
    },
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    cashBuyer: "7-14 days",
    traditional: "50-80 days (50 DOM + 30-45 close)",
  },
  {
    label: "Repairs required",
    cashBuyer: "None — we buy as-is",
    traditional: "Usually required ($5K-$25K avg on older Bloomington stock)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$15,000-$18,000 on Redfin $300K median)",
  },
  {
    label: "IL transfer tax (state + McLean County)",
    cashBuyer: "We cover everything",
    traditional: "$300 on a $200K sale — no Bloomington municipal RETT",
  },
  {
  ...
  },
  {
    ...
    cashBuyer: "70-78% of FMV",
    traditional: "85-91% after all costs (well-maintained only)",
  },
];
...
const FAQ_ITEMS = [
  ...
  {
    question:
      "Is the Bloomington IL housing market really as hot as I've heard?",
    answer:
...
export default function BloomingtonILMarketPage() {
  const howToSchema = {
    ...
    description:
      "Step-by-step process for selling your Bloomington or McLean County home for cash",
    step: [
      {
        "@type": "HowToStep",
        name: "Submit Your Property Info",
        text: "Fill out our 2-minute form with your Bloomington or McLean County property address, condition, and timeline.",
        position: 1,
      },
      {
        "@type": "HowToStep",
      ...
      },
      {
        ...
        text: "Sign at a Bloomington IL title company of your choice, walk away with your cash. No repairs, no cleanout.",
        position: 4,
      },
    ],
  };
  ...
  return (
    <>
      <SchemaMarkup
        schema={[
          bloomingtonILLocalBusinessSchema,
          faqSchema(FAQ_ITEMS),
          howToSchema,
          videoObjectSchema({
            name: "Sell My House Fast Bloomington IL — USA Home Buyers",
            description:
              "Cash offers for Bloomington, Normal, and McLean County homes — any condition",
            contentUrl: `${SITE_URL}/videos/bloomington-il/landing.mp4`,
            thumbnailUrl: `${SITE_URL}/videos/bloomington-il/landing-poster.jpg`,
          }),
        ]}
      />
      ...
      <section className="relative text-white py-8 md:py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          <source
            ...
            srcSet="/images/optimized/bloomington-il-hero-1200.jpg"
          />
          <source
            media="(min-width: 1080px)"
            srcSet="/images/optimized/bloomington-il-hero-1080.jpg"
          />
          <source
            media="(min-width: 828px)"
            srcSet="/images/optimized/bloomington-il-hero-828.jpg"
          />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Bloomington cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Bloomington house in any
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            <p className="text-sm font-semibold text-brand-primary mb-2">
              Bloomington mini-site
            </p>
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Bloomington homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Bloomington section for local market data, situation
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/markets/bloomington-il/resources"
            ...
            <Link
              href="/guides/sell-house-fast-bloomington-il-2026"
      ...
      <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
        ...
        <div className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
          Need to sell your house fast in Bloomington, Illinois? USA Home Buyers
          purchases homes as-is for cash throughout McLean County. No agents, no
          fees, no repairs. Written cash offer in 24 hours, close in 7 days.
          Call 888-274-5006.
        </div>
      </details>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-12">
          <h2 className="text-2xl md:text-3xl font-bold text-brand-dark mb-6">
            Bloomington IL Real Estate Market — What Sellers Need to Know in
            2026
          </h2>
          <p className="text-gray-700 mb-4">
            Bloomington is the insurance capital of downstate Illinois — and
            that distinction shapes its housing market in ways that set it apart
            from every other city in our Illinois portfolio. State Farm
            Insurance, founded here in 1922, operates its world headquarters in
            Bloomington, making it the largest mutual insurer in the United
            States by premium volume. Country Financial, another major national
            property-and-casualty insurer, also maintains its headquarters here.
            Together with Illinois State University in adjacent Normal and
            Illinois Wesleyan University within Bloomington city limits, the
            city has built an employment base unlike anything you find in a
            comparably sized downstate market.
          </p>
          <p className="text-gray-700 mb-4">
            That employment base drives the housing market data. According to
            the Zillow Research City ZHVI CSV (2026-03-31), the Bloomington Home
            Value Index (ZHVI) stands at $261,269 — up 2.7% year over year, the
            fastest appreciation rate of any market in our three-city Illinois
            batch. Per Redfin (Bloomington city, Mar 2026), the city median sale
            price reached $300,000, a 32.6% year-over-year jump reflecting both
            genuine price increases and the thin-market mix-effects of just 83
            transactions in one month. Homes go pending in roughly 4 days on
            average per Zillow — a pace that puts Bloomington among the most
            competitive mid-size Midwest markets.
          </p>
          <p className="text-gray-700 mb-4">
            The median household income in Bloomington is $77,384 (2024 ACS
            estimate), the highest of any city in our IL market set and well
            above the Illinois statewide median of roughly $72,000. McLean
            County's median property tax rate runs 2.62% of assessed value —
            significantly above the national median — which creates seller
            motivation among fixed-income homeowners, particularly retirees who
            carry low or no mortgages but face mounting annual property tax
            bills.
          </p>
          <p className="text-gray-700 mb-4">
            Bloomington's motivated-seller profile is distinct from Rockford's
            or Springfield's. Here, the drivers are State Farm and Country
            Financial retirees whose estates pass to out-of-state adult
            children, ISU-adjacent landlords tired of managing student rental
            properties, professionals relocating when insurance industry
            restructuring creates early-retirement packages, and owners of older
            homes in Founders' Grove and West Bloomington who face deferred
            maintenance on historic stock they can't afford to remediate. These
            are equity-rich sellers — many with 30-40 years of ownership — who
            need a clean, certain transaction more than the last dollar of
            retail price.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="bg-white">
                  ...
                  <td className="p-3">$261,269 (+2.7% YoY)</td>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">$300,000 (+32.6% YoY)</td>
                  <td className="p-3 text-gray-500">
                    Redfin Bloomington city (Mar 2026)
                  </td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">Avg. Days to Pending</td>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">65/100 — Somewhat Competitive</td>
                ...
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Homes Sold (Mar 2026)</td>
                  <td className="p-3">83</td>
                  <td className="p-3 text-gray-500">Redfin (Mar 2026)</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">RDC Hotness Rank</td>
                  <td className="p-3">#27 (Bloomington-Normal MSA)</td>
                  <td className="p-3 text-gray-500">
                    Realtor.com hotness context (not Zillow/Redfin source
                    freshness)
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  ...
                  <td className="p-3">$77,384</td>
                  <td className="p-3 text-gray-500">ACS 2024</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-medium">
                    IL Transfer Tax (state + McLean Co.)
                  </td>
                  <td className="p-3">
                    $300 on $200K sale (0.15%) — no municipal RETT
                  </td>
                  <td className="p-3 text-gray-500">
                    35 ILCS 200/31-10; McLean Co. Code
                  </td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-medium">Foreclosure type</td>
                  <td className="p-3">
                    Judicial — 735 ILCS 5/15-1101 (12-16 mos typical)
                  </td>
                  <td className="p-3 text-gray-500">
                ...
                <tr className="bg-white">
                  ...
                  <td className="p-3">
                    McLean Co. Circuit Court, 104 W. Front St Rm 404, (309)
                    888-5350
                  </td>
                  <td className="p-3 text-gray-500">11th Judicial Circuit</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-600 italic">
            What this means for Bloomington sellers: this is not a distress
            market — it is a professional-class market with a distinct
            motivated-seller population. Equity-rich estates, landlord exits,
            and insurance-industry early-retirement packages drive the
            cash-buyer pipeline here more than financial hardship. A 4-day
            pending pace means retail-ready homes move fast; but Founders' Grove
            Victorians with deferred maintenance, ISU-area rental conversions,
            and West Bloomington code-issue properties represent a meaningful
            share of the seller pool that needs a buyer who doesn't require a
          ...
          situations={[
            {
              ...
              href: "/markets/bloomington-il/inherited-property",
              description:
        ...
        <TestimonialBlock
          ...
          heading="What Bloomington IL Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            Per Redfin (March 2026), the Bloomington median sale price is
            $300,000. A 5-6% agent commission runs $15,000-$18,000. Add
            Illinois&apos;s combined transfer tax ($300 on a $200K sale),
            Redfin&apos;s 50-day average days on market, and repair requests on
            older Bloomington housing stock. Founders&apos; Grove Victorians and
            West Bloomington pre-1950s homes frequently carry deferred
            maintenance — original wiring, aging plumbing, historic-district
            exterior restrictions — that conventional buyers flag and require
            repair credits on. A cash offer eliminates inspection contingencies
            entirely. At $261,269 Zillow Research city ZHVI average, every
            dollar of commission and carrying cost is meaningful relative to the
            net proceeds.
          </p>
        </section>
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Bloomington IL Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our Bloomington coverage includes the entire city — Founders&apos;
            Grove Historic District on the east side with its Victorian and
            Craftsman homes dating to the 1880s-1920s, Downtown Bloomington
            along the Washington Street corridor with older worker-class housing
            stock, Alton-Oakland on the east side with 1940s-1960s bungalows,
            Holiday Knolls and Holiday Acres in the mid-city with established
            mid-century homes, Sherwood Forest in the northeast with 1950s-1970s
            ranches, West Bloomington and Sunset Hills in the southwest with the
            city&apos;s highest concentration of pre-1950 housing, the Veterans
            Parkway Corridor and Eastview near ISU with its rental-heavy grad
            student population, North Bloomington&apos;s executive-commuter
            ranch and colonial homes, and the newer Pepper Ridge and Northbrook
            subdivisions in the northeast.
          </p>
          <p className="text-gray-700 mb-4">
            We serve the surrounding McLean County communities — Normal
            (immediately north, home of ISU), Heyworth, LeRoy, Lexington,
            Towanda, Hudson, Downs, Gridley, and rural McLean County parcels.
            McLean County is the largest county by land area in Illinois — we
            cover it entirely.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          ...
          <p className="text-gray-700 text-sm mb-3">
            From Founders&apos; Grove Victorians to North Bloomington colonials
            to ISU-area rentals — we buy in every Bloomington neighborhood and
            every McLean County community.
          </p>
          <Link
            href="/markets/bloomington-il/neighborhoods"
            className="text-brand-primary hover:underline font-medium text-sm"
          >
            See Bloomington neighborhood-by-neighborhood price ranges →
          </Link>
        </section>

        <section className="my-8 bg-blue-50 border border-blue-100 rounded-2xl p-6">
          <h2 className="text-xl font-bold text-brand-dark mb-2">
            Our Third Illinois Market
          </h2>
          <p className="text-gray-700 text-sm mb-3">
            Bloomington is our third Illinois market, following Springfield
            (Sangamon County) and Rockford (Winnebago County). For statewide
            Illinois legal context — transfer taxes, foreclosure law, probate
            procedures — see our Illinois state guide.
          </p>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              ...
              your Bloomington IL or McLean County home.
            </p>
          </div>
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Bloomington IL Home?"
            sourcePage="/markets/bloomington-il"
          />
        </section>
      </div>
