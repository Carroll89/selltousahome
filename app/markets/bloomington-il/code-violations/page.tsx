  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Sell a House With Code Violations in Bloomington IL',
          description: 'Open violations, failed inspections — we buy as-is in McLean County',
          contentUrl: `${SITE_URL}/videos/bloomington-il/code-violations.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/bloomington-il/code-violations-poster.jpg`,
        }),]} />
