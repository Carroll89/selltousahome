  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        videoObjectSchema({
          name: 'Facing Foreclosure in Bloomington IL?',
          description: 'Sell before the McLean County auction — protect your equity and credit',
          contentUrl: `${SITE_URL}/videos/bloomington-il/foreclosure.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/bloomington-il/foreclosure-poster.jpg`,
        }),]} />
