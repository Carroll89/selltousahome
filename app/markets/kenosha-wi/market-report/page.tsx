      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8">
          ...
          <p className="text-sm text-blue-900 leading-relaxed">
            According to Zillow Research (City ZHVI CSV, 2026-03-31), the Kenosha city median home value is $273,053. Redfin (March 2026) reports a median sale price of $279,500 and approximately 35 days on market. Transfer tax: $3.00 per $1,000 (realty transfer fee, seller pays). Foreclosure process: Judicial. For a cash offer based on current Kenosha market conditions, call USA Home Buyers at 888-274-5006.
          </p>
        </div>

        <section className="mb-10">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Key Market Metrics — Kenosha WI</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-white"><td className="p-3 font-medium">Price per sq ft</td><td className="p-3">$183</td><td className="p-3 text-gray-500">Redfin (Mar 2026)</td></tr>
                ...
                <tr className="bg-white"><td className="p-3 font-medium">Typical cash offer range</td><td className="p-3">70-80% of FMV</td><td className="p-3 text-gray-500">Local investor norms</td></tr>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Neighborhood Breakdown — Kenosha WI</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-brand-primary text-white">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-gray-50"><td className="p-3 font-medium">Lincoln Park</td><td className="p-3">$190,000-$279,500</td></tr>
                <tr className="bg-white"><td className="p-3 font-medium">Pleasant Prairie (North)</td><td className="p-3">$250,000-$310,000</td></tr>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            A direct cash sale to USA Home Buyers closes in 7–14 days with no repairs required. We cover all closing costs including $3.00 per $1,000 (realty transfer fee, seller pays). The trade-off: cash offers typically run 70-80% of fair market value.
          </p>
        </section>
        ...
        <div className="mt-8 text-sm text-gray-500">
          <p>Data sources: Zillow Home Value Index (ZHVI), Redfin market statistics, U.S. Census Bureau American Community Survey. Market data reflects conditions as of March 2026. Individual property values vary. Contact us for a property-specific assessment.</p>
        </div>
      </div>
    </>
  );
