...
const pageUrl = `${SITE_URL}/markets/kenosha-wi/fire-damage`;

export const metadata: Metadata = {
  title: 'Sell Fire Damaged House Kenosha WI',
  description:
    'Selling a fire-damaged house in Kenosha WI? We buy fire-damaged properties as-is. No restoration required. Written offer in 24 hours.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Can I sell a fire-damaged house in Kenosha WI?',
    answer: 'Yes. We buy fire-damaged properties in Kenosha at any stage — partial damage with smoke and water, structural fire damage, total losses. We assess the land value, salvageable structure, and remediation costs to make a fair offer.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We have purchased condemned and red-tagged properties in Kenosha. Condemnation limits your conventional sale options but not your cash sale options. We can close quickly and take responsibility for addressing the condemnation order.',
  },
  {
...
export default function KenoshaFireDamagePage() {
  return (
    <>
      <SchemaMarkup schema={[
        kenoshWILocalBusinessSchema,
        articleSchema('Sell Your Fire-Damaged Kenosha WI House — Fast, As-Is', pageUrl, '2026-04-16'),
        faqSchema(FAQ_ITEMS),
      ]} />
      ...
      <section className="relative text-white py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          ...
          <img
            ...
            alt="Kenosha WI homes — Sell Your Fire-Damaged Kenosha WI House — Fast, As-Is"
            fetchPriority="high"
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-blue-300 text-sm font-medium mb-2">
              <Link href="/markets/kenosha-wi" className="hover:text-white">Kenosha WI</Link> › Fire Damage
            </p>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell Your Fire-Damaged Kenosha WI House — Fast, As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">USA Home Buyers purchases fire-damaged properties in Kenosha WI — partial burns, smoke damage, total losses. We buy as-is, no restoration required. Written cash offer based on land value and salvageable structure in 24 hours. Call 888-274-5006.</p>
            </div>
          ...
          <div>
            <CashOfferForm variant="hero" headline="Get Your Cash Offer" subheadline="Written offer in 24 hours. We cover all closing costs." sourcePage="/markets/kenosha-wi/fire-damage" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Fire Damage in Kenosha WI" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Kenosha WI Property?" sourcePage="/markets/kenosha-wi/fire-damage" />
      </div>
    </>
  );
}
