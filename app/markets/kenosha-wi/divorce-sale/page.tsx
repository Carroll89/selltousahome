        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">USA Home Buyers purchases houses in Kenosha WI during divorce proceedings. We give one written offer, one closing date, and proceeds split through attorneys at closing. Written cash offer in 24 hours, close in 7-14 days. No repairs. Call 888-274-5006.</p>
            </div>
