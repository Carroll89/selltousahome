    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            We frequently work with estates throughout Kenosha County. We can have a written offer ready before you even file for probate, so you can close once authority is granted; court process can vary. Transfer tax: Wisconsin realty transfer fee — $3.00 per $1,000 of consideration, paid by seller. On a $279,500 sale: $839. Source: Wisconsin Department of Revenue (revenue.wi.gov).
          </p>
        </section>
