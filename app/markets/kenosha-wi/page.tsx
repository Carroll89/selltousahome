...
export default function KenosaWIMarketPage() {
  ...
  return (
    <>
      <SchemaMarkup schema={[kenoshWILocalBusinessSchema, faqSchema(FAQ_ITEMS), howToSchema, videoObjectSchema({ name: 'Sell My House Fast Kenosha WI — USA Home Buyers', description: 'Cash offers for Kenosha and Kenosha County homes — any condition', contentUrl: `${SITE_URL}/videos/kenosha-wi/landing.mp4`, thumbnailUrl: `${SITE_URL}/videos/kenosha-wi/landing-poster.jpg`, uploadDate: '2026-04-28' })]} />
      ...
      <VideoEmbed
        ...
        poster="/videos/kenosha-wi/landing-poster.jpg"
        />
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Kenosha homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Kenosha section for local market data, situation
