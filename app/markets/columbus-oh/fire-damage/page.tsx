...
const pageUrl = `${SITE_URL}/markets/columbus-oh/fire-damage`;

export const metadata: Metadata = {
  title: 'Sell Fire-Damaged House Columbus OH — We Buy As-Is Cash',
  description:
    'Need to sell a fire-damaged or smoke-damaged house in Columbus OH? USA Home Buyers purchases fire-damaged homes as-is in Franklin County — cash offer in 24 hours, no repairs required.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Will you buy a fire-damaged house in Columbus OH?',
    answer:
      "Yes. We purchase fire-damaged and smoke-damaged homes throughout Columbus and Franklin County as-is. No cleanup, no repairs, no board-up required on your end. We make an offer based on current condition and close quickly. Call 888-274-5006.",
  },
  {
...
export default function ColumbusFireDamagePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          columbusLocalBusinessSchema,
          articleSchema('Sell a Fire-Damaged House in Columbus OH', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Fire-Damaged House in Columbus OH — Cash As-Is Buyer
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">
                USA Home Buyers purchases fire-damaged and smoke-damaged homes throughout Columbus
                and Franklin County — any level of damage, any condition. No repairs, no cleanup,
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/columbus-oh/fire-damage"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Selling a Fire-Damaged Property in Columbus — What You Need to Know
          </h2>
          ...
          <p className="text-gray-700 mb-4">
            Columbus's rubber-era housing stock — dense bungalows, two-stories, and foursquares
            in Goodyear Heights, Kenmore, and East Columbus — often has knob-and-tube wiring and
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Fire-Damaged Home Sales in Columbus OH" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell Your Fire-Damaged Columbus OH Property?"
          sourcePage="/markets/columbus-oh/fire-damage"
        />
      </div>
    </>
