    ...
    <>
      ...
      <section className="relative text-white py-8 md:py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          <source
            srcSet="/images/optimized/reading-landmark-hero-640.jpg 640w, /images/optimized/reading-landmark-hero-828.jpg 828w, /images/optimized/reading-landmark-hero-1080.jpg 1080w, /images/optimized/reading-landmark-hero-1200.jpg 1200w"
            type="image/jpeg"
            sizes="100vw"
          />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/images/optimized/reading-landmark-hero-1200.jpg"
