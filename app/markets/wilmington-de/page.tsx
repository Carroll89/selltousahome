  ...
  return (
    <>
      ...
      <section className="relative text-white py-8 md:py-16 px-4 overflow-hidden">
        ...
        If you need to sell your house fast in Wilmington, Delaware — you've found the right team. We're USA Home Buyers, and we purchase houses as-is, for cash, throughout New Castle County. Whether your home needs repairs, you're behind on payments, going through a divorce, or you've inherited a property you don't know what to do with — we make the process simple. No agents. No fees. No repairs needed. We buy Wilmington homes in any condition — brick row homes, pre-war two-stories, or anything in between. Written cash offer within 24 hours. Close in as few as seven days on your schedule. Call us now at 888-440-5250. That's 888-440-5250.
        </div>
        </details>
