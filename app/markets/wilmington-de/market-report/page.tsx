...
const FAQ_ITEMS = [
  {
    ...
    answer: "Wilmington DE is a somewhat competitive market. According to Redfin (February 2026), Wilmington has a Compete Score of 61/100. Homes are selling at 98.7% of list price with a median of 72 days on market. That 72-day DOM is significantly longer than most PA markets — reflecting a buyer pool that negotiates carefully on aging urban housing stock.",
  },
  {
    question: 'What is the average home price in Wilmington DE?',
    answer: "Wilmington's median sale price is $210,000 (Redfin, February 2026), down 6.7% year-over-year. The Zillow ZHVI for the broader area is $326,763 (+3.0% YoY). The price discrepancy reflects Redfin's city-limits transaction data versus Zillow's broader geographic index that includes surrounding suburbs at higher price points.",
  },
  {
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <tbody>
                {[
                  ['Median sale price — Wilmington City', '$210,000', 'Redfin, Feb 2026'],
                  ['YoY change — sale price', '-6.7%', 'Redfin, Feb 2026'],
                  ['Median home value (Zillow ZHVI)', '$326,763', 'Zillow, Feb 2026'],
                  ['YoY change — ZHVI', '+3.0%', 'Zillow, Feb 2026'],
                  ['Price per square foot', '$170/sqft', 'Redfin, Feb 2026'],
                  ['YoY change — price/sqft', '+6.3%', 'Redfin, Feb 2026'],
                  ['Median days on market', '72 days', 'Redfin, Feb 2026'],
                  ['Sale-to-list ratio', '98.7%', 'Redfin, Feb 2026'],
                  ['Redfin Compete Score', '61/100 — Somewhat Competitive', 'Redfin, Feb 2026'],
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 mb-4">
            On the Wilmington median sale price of $210,000, the total transfer tax is $8,400 — the seller's
            conventional share is $4,200. When you sell to USA Home Buyers, we cover all closing costs including
