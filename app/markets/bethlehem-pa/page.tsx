...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/images/bethlehem-pa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Bethlehem PA South Side homes — Sell Your House Fast",
      },
    ],
  },
};
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "I owned a rental on West 4th Street, tenant stopped paying during COVID and I never got fully caught up with the mortgage after. When I found out about the foreclosure timeline in Northampton County I knew I needed to move fast. Got a written offer in 20 hours, closed before the sheriff sale was scheduled.",
    name: "Marcus T.",
  ...
  {
    quote:
      "Going through a divorce, we needed to sell the house on Prospect Avenue quickly and split the money cleanly. No arguments about repairs, no real estate agent drama. USA Home Buyers gave us one written number, we both signed, and it was done in 12 days.",
    name: "Denise R.",
  ...
  {
    quote:
      "I had two student rentals near Lehigh on Brodhead Avenue. The last set of tenants left the basement flooded with the pipes disconnected and the carpets destroyed. It would have cost $22,000 just to make it rentable again. USA Home Buyers bought both properties in one transaction, as-is. Closed in fifteen days.",
    name: "Kevin O.",
  ...
  {
    quote:
      "Got an offer from St. Luke's in their Phoenix satellite and had six weeks to move. I'd owned my house in Fountain Hill for nine years — good bones but the kitchen hadn't been touched since the nineties. USA Home Buyers had a number in twenty-four hours. We closed the day before I drove to Arizona.",
    name: "Anita S.",
  ...
  {
    quote:
      "I'm seventy-one and I've been in my house on Heckewelder Street since 1994. My cardiologist told me the stairs weren't doing me any favors. USA Home Buyers made me a fair offer. I moved into a ground-floor apartment in seven days. Didn't have to stage a single room.",
    name: "Eleanor V.",
...
const COMPARISON_ROWS = [
  ...
  },
  {
    ...
    traditional: "Usually required ($8K-$25K avg)",
  },
  {
    label: "Agent commissions",
    cashBuyer: "$0",
    traditional: "5-6% (~$15,550-$18,660 on $311K home)",
  },
  {
    label: "Transfer tax (2%)",
    cashBuyer: "We cover all closing costs",
    traditional: "Seller pays ~1% local portion ($3,110)",
  },
  {
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Once you accept a written offer, we typically close in 7-14 days. We send the written offer within 24 hours of your inquiry. According to Redfin, Bethlehem homes sell in about 20 days on the open market — but that path requires showings, inspections, and waiting on mortgage lender approval. With a cash sale, there's no bank involved, no contingency waiting period.",
  },
  {
    question: "What is the transfer tax when selling in Bethlehem PA?",
    answer:
      "Bethlehem PA has a 2% total real estate transfer tax — 1% Pennsylvania state tax plus 1% City of Bethlehem local tax. By convention, buyer and seller each pay half (1% each). On a $311,000 home, the total is $6,220 — seller's share is $3,110. When you sell to us, we cover all closing costs including the full transfer tax. Source: City of Bethlehem Ordinance Article 335.",
  },
  {
    question: "How much will you pay for my Bethlehem house?",
    answer:
      "Cash offers for Bethlehem homes typically range from 70-80% of fair market value. According to Redfin, Bethlehem's median sale price is $311,000 (Redfin, March 2026), with a Zillow home value of $351,353. For a South Side row home near the $245,000 median, a cash offer is approximately $172,000-$196,000. We cover all closing costs — no agent commissions, no fees deducted from your number.",
  },
  {
    question: "Do I need to make repairs before selling?",
    answer:
      "No. Bethlehem's housing stock is dominated by pre-war row homes and twins — 30.8% of the city's housing units are attached structures, most built between 1890 and 1930 for Bethlehem Steel workers. Deferred maintenance, aging systems, and code issues are common. We buy in any condition. Leave whatever you don't want.",
  },
  {
    question: "What neighborhoods in Bethlehem do you buy in?",
    answer:
      "All of Bethlehem and the surrounding area — South Side, Central Bethlehem, West Side, Northeast Bethlehem, and the Historic North Side. We also serve Fountain Hill, Hellertown, Hanover Township, Bethlehem Township, Freemansburg, Nazareth, Palmer Township, Easton, Northampton, Emmaus, Whitehall Township, Catasauqua, and Wilson Borough.",
  },
  {
    question:
      "¿Compran casas en Bethlehem PA? / Do you work with Spanish-speaking sellers?",
    answer:
      "Sí, hablamos español. According to the U.S. Census Bureau ACS 2024, 31.3% of Bethlehem residents identify as Hispanic or Latino. We serve Bethlehem's South Side community — call us in English or Spanish. We understand the neighborhood, the housing stock, and the process.",
  },
  {
    question: "Is USA Home Buyers a legitimate company?",
    answer:
      "We're a legitimate Pennsylvania LLC. Every offer is in writing — a formal purchase agreement with price, terms, and closing date. No verbal promises. You can verify our Pennsylvania business registration at corporations.pa.gov. We've closed sales across Northampton County and the Lehigh Valley.",
  },
  {
      ...
      <SchemaMarkup
        schema={[
          ...
          videoObjectSchema({
            ...
            thumbnailUrl: `${SITE_URL}/videos/bethlehem-pa/landing-poster.jpg`,
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-[minmax(0,1fr)_430px] gap-5 lg:gap-10 items-start">
          <div className="order-1 lg:col-start-1 lg:row-start-1">
            <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-blue-100 ring-1 ring-white/20 mb-3">
              Bethlehem cash home buyer · Written offer in 24 hours
            </p>
            ...
            <p className="text-base md:text-lg text-blue-100 lg:hidden">
              Get a written cash offer for your Bethlehem house in any condition
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          <div>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mb-2">
              Seller resources for Bethlehem homeowners
            </h2>
            <p className="text-gray-700 max-w-3xl">
              Stay in the Bethlehem section for local market data, situation
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="my-10 bg-blue-50 border-l-4 border-brand-primary rounded-r-2xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-4">
            Bethlehem isn&apos;t a suburb. It&apos;s a former industrial city —
            home to Bethlehem Steel, once the second-largest steel producer in
            the world. The South Side neighborhoods were built almost entirely
            between 1890 and 1930 to house steelworkers and their families.
            According to the U.S. Census Bureau, 30.8% of Bethlehem&apos;s
            housing units are attached row homes — a density unusual outside
            Philadelphia.
          </p>
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            {[
              {
                label: "Attached row homes",
                value: "30.8%",
                note: "Of all housing units — Census 2020",
              },
              {
                label: "Compete Score (Redfin)",
                value: "90/100",
                note: "Very competitive seller's market",
              },
              {
                label: "Hispanic residents",
                value: "31.3%",
                note: "Hablamos español — ACS 2024",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <p className="text-gray-700 text-sm">
            These homes have character — brick facades, front stoops, narrow
            lots. They also have aging electrical, original plumbing, and
            deferred maintenance that&apos;s common when properties pass through
            generations. That&apos;s exactly the kind of house we buy every
            week.
          </p>
        </section>
        ...
        <section className="my-10 bg-brand-light rounded-2xl p-8">
              ...
              <tbody>
                {[
                  ...
                  [
                    ...
                    "$218,000–$249,000 (70-80% of $311K median)",
                  ],
                  [
                    "South Side row home range",
                    "$172,000–$196,000 (70-80% of ~$245K)",
                  ],
                  [
                    "Transfer tax",
                    "2% total (1% PA state + 1% City of Bethlehem)",
                  ],
                  [
                    "Typical realtor commission",
                    "5–6% (~$15,550-$18,660 on $311K home)",
                  ],
                  [
                    "Housing composition",
                    "30.8% attached row homes — Census 2020",
                  ],
          ...
          <p className="mt-2 text-sm text-gray-600">
            Bethlehem&apos;s market is highly competitive — homes receive an
            average of 5 offers and sell at 99.8% of list price. But that&apos;s
            only for move-in-ready properties. South Side row homes with
            deferred maintenance, code issues, or complicated ownership
            situations sit longer. For those sellers, a cash offer provides
            certainty the retail market can&apos;t match.
          </p>
          <p className="mt-2 text-sm">
            <Link
              href="/markets/bethlehem-pa/market-report"
        ...
        <VideoEmbed
          ...
          poster="/videos/bethlehem-pa/landing-poster.jpg"
        ...
        <div className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
          ...
          <p className="px-4 pb-4 text-sm text-gray-600 leading-relaxed">
            ...
            for Bethlehem and Northampton County sellers. It highlights fast
            written offers, as-is purchases with no repairs or agent
            commissions, and common Bethlehem situations such as inherited South
            Side row homes, foreclosure pressure, divorce sales, tenant-occupied
            properties, storm damage, and older homes with deferred maintenance.
            Exact captions are pending human audio review; no transcript is
            being claimed until verified.
          </p>
        </div>
          ...
          situations={[
            {
              ...
              href: "/markets/bethlehem-pa/inherited-property",
              description:
                "Sell an inherited South Side row home without cleanout or repairs",
            },
            {
              label: "Going Through Divorce",
              href: "/markets/bethlehem-pa/divorce-sale",
              description:
                "Close quickly, split proceeds cleanly — minimal conflict",
            },
            {
              label: "Facing Foreclosure",
              href: "/markets/bethlehem-pa/foreclosure",
              description:
                "Northampton County foreclosure timeline is 12-18 months — sell now",
            },
            {
              label: "Tenant-Occupied Property",
              href: "/markets/bethlehem-pa/tenant-occupied",
              description:
                "We buy with tenants still in place — no eviction needed",
            },
            {
              label: "Code Violations",
              href: "/markets/bethlehem-pa/code-violations",
              description:
                "Open permits, failed inspections — we buy it anyway",
            },
            {
              label: "Fire Damage",
              href: "/markets/bethlehem-pa/fire-damage",
              description:
                "Fire or smoke damage? We purchase as-is with no cleanup required",
            },
            {
              label: "Probate Sale",
              href: "/markets/bethlehem-pa/probate",
              description:
                "We work with Northampton County estate executors regularly",
            },
            {
        ...
        <TestimonialBlock
          ...
          heading="What Bethlehem PA Homeowners Are Saying"
        />
        ...
        <section className="my-12">
          ...
          <p className="mt-4 text-sm text-gray-600">
            On a $311,000 Bethlehem home, a 5-6% agent commission is
            $15,550-$18,660. Add inspection repairs on a 100-year-old South Side
            row home, 45-60 days of carrying costs, and transfer tax — the real
            gap between a cash offer and a traditional listing is smaller than
            most sellers expect, and the certainty is incomparable.
          </p>
        </section>
        ...
        <section className="my-10 bg-green-50 border border-green-200 rounded-2xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-3">
            According to the U.S. Census Bureau, 31.3% of Bethlehem residents
            are Hispanic or Latino. The South Side has a vibrant Puerto Rican
            and Dominican community that has called this neighborhood home for
            generations.
          </p>
          <p className="text-gray-700 mb-4">
            Vendemos casas en Bethlehem, PA. Si necesita vender su casa rápido —
            sin reparaciones, sin agentes, sin complicaciones — llámenos.
            Ofrecemos efectivo en 24 horas y cerramos en 7 días. Hablamos
            español.
          </p>
          <a
            href={`tel:${PHONE}`}
        ...
        <FAQSection
          items={FAQ_ITEMS}
          heading="Frequently Asked Questions — Selling Your Bethlehem PA Home for Cash"
        />
        ...
        <section className="my-12">
          ...
          <p className="text-gray-700 mb-4">
            Our primary market is the City of Bethlehem — South Side, Central
            Bethlehem, West Side, Northeast Bethlehem, and the Historic North
            Side. We know these neighborhoods: the dense row homes near
            SteelStacks, the brick twins on the West Side, the Victorian-era
            houses near Moravian University.
          </p>
          <p className="text-gray-700 mb-4">
            We also serve the surrounding communities throughout Northampton and
            Lehigh counties: Fountain Hill (adjacent borough), Hellertown,
            Bethlehem Township, Hanover Township, Freemansburg, Nazareth,
            Northampton Borough, Palmer Township, Wilson Borough, Easton,
            Emmaus, Whitehall Township, and Catasauqua.
          </p>
        ...
        <section className="my-8 bg-brand-light rounded-2xl p-6">
          ...
          <p className="text-gray-700 text-sm mb-3">
            From South Side row homes near SteelStacks to the Historic District
            on the North Side — we buy in every Bethlehem neighborhood.
          </p>
          <Link
            href="/markets/bethlehem-pa/neighborhoods"
        ...
        <section className="my-12">
          <CashOfferForm
            variant="footer"
            headline="Ready to Sell Your Bethlehem PA Home?"
            sourcePage="/markets/bethlehem-pa"
          />
        </section>
      </div>
