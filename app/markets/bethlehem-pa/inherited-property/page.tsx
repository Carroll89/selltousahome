    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border-l-4 border-brand-primary rounded-r-xl p-6 mb-10">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">If you inherited a house in Bethlehem, PA, you likely need to complete probate through the Northampton County Register of Wills before selling — unless the property was held jointly or in a living trust. PA probate typically takes 9–14 months in Northampton County. USA Home Buyers buys inherited properties in Bethlehem as-is — no repairs or cleanout required.</p>
        </div>
