    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border-l-4 border-brand-primary rounded-r-xl p-6 mb-10">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">Yes, USA Home Buyers buys tenant-occupied properties in Bethlehem, PA. Pennsylvania law (68 P.S. § 250.101 et seq.) requires existing leases to transfer with the property — the new owner becomes the landlord. Fixed-term leases must be honored until expiration; month-to-month tenancies can be terminated with 15–30 days notice depending on lease length. We buy with the tenant in place — no eviction required before closing. Written cash offer within 24 hours.</p>
        </div>
