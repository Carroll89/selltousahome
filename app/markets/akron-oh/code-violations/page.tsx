...
const pageUrl = `${SITE_URL}/markets/akron-oh/code-violations`;

export const metadata: Metadata = {
  title: 'Sell House With Code Violations Akron OH — We Buy As-Is',
  description:
    'Have open code violations on your Akron OH home? USA Home Buyers purchases homes with code violations, open permits, or city notices in Summit County — cash offer in 24 hours, close as-is.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Will you buy my Akron house with open code violations?',
    answer:
      "Yes. We purchase houses with open Akron code violations, city notices, or Summit County administrative orders as-is. We resolve violations and liens at or after closing — you don't need to fix anything. Call 888-274-5006.",
  },
  {
    question: 'What kinds of code violations are common in Akron OH homes?',
    answer:
      "Common Akron violations in older housing stock include: structural issues (failing foundations, rotted sills), roof and exterior violations, overgrown vegetation, derelict outbuildings, plumbing and electrical deficiencies, and interior habitability issues. With 34.1% of Akron's housing built in 1939 or earlier, code issues in older neighborhoods like Goodyear Heights, Kenmore, South Akron, and East Akron are common. We've bought properties with all of these issues.",
  },
  {
    question: 'Can I still sell if Akron has issued a demolition order?',
    answer:
...
export default function AkronCodeViolationsPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          akronLocalBusinessSchema,
          articleSchema('Sell House With Code Violations in Akron OH', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a House With Code Violations in Akron OH — We Buy As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">
                Open code violations, city notices, or administrative orders don't prevent a cash
                sale. USA Home Buyers purchases Akron homes with code issues as-is throughout
                Summit County — any condition, any neighborhood. Written cash offer in 24 hours,
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/akron-oh/code-violations"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Code Violations in Akron OH — Why They're So Common
          </h2>
          <p className="text-gray-700 mb-4">
            Akron's housing stock is among the oldest in Ohio. With 34.1% of units built in 1939
            or earlier and many more built in the 1940s–1960s, Goodyear Heights, Kenmore,
            Firestone Park, East Akron, and South Akron are full of bungalows, two-stories, and
          ...
          <p className="text-gray-700 mb-4">
            The City of Akron's Building Department enforces housing standards including
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Selling With Code Violations in Akron OH" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell Your Akron OH Property With Code Violations?"
          sourcePage="/markets/akron-oh/code-violations"
        />
      </div>
    </>
