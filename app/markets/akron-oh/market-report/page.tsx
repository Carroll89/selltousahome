...
const pageUrl = `${SITE_URL}/markets/akron-oh/market-report`;

export const metadata: Metadata = {
  title: 'Akron OH Housing Market Report 2026 — Prices & Trends',
  description:
    'Akron OH real estate market data for 2026. Median prices, Summit County trends, neighborhood character, and what it means for sellers.',
  alternates: { canonical: pageUrl },
};

export default function AkronMarketReportPage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          akronLocalBusinessSchema,
          articleSchema('Akron OH Housing Market Report 2026', pageUrl, '2026-05-01'),
        ]}
      />
      <section className="relative text-white py-12 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <p className="text-blue-300 text-sm font-medium mb-2">
            <Link href="/markets/akron-oh" className="hover:text-white">Akron OH</Link> › Market Report
          </p>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Akron OH Housing Market Report — 2026</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8">
          ...
          <p className="text-blue-700 text-sm leading-relaxed">
            According to Redfin (March 2026), Akron's median sale price is $151,750 — up 21.4%
            year-over-year — with 42 days on market and a Compete Score of 73/100. USA Home Buyers
            purchases Akron homes for cash in any condition, any situation. Written offer in 24
            hours, close in 7–14 days. Call 888-274-5006.
          </p>
        </div>

        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Akron OH Market Overview</h2>
          <p className="text-gray-700 mb-4">
            Akron is the county seat of Summit County, Ohio — the former rubber capital of the world.
            ...
            Goodyear Heights and Kenmore to Firestone Park and East Akron. With a Compete Score of
            73/100 and a median sale price of $151,750 (up 21.4% YoY per Redfin March 2026), Akron
          ...
          <div className="overflow-x-auto mb-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-white"><td className="p-3 font-medium">OH conveyance fee</td><td className="p-3">$4.00/$1,000 + $0.50/lot (Summit County Fiscal Office)</td><td className="p-3 text-gray-500">Summit County Fiscal Office</td></tr>
                <tr className="bg-gray-50"><td className="p-3 font-medium">Recording fee</td><td className="p-3">$34 first 2 pages + $8/additional page</td><td className="p-3 text-gray-500">Summit County Fiscal Office Recording Division</td></tr>
                <tr className="bg-white"><td className="p-3 font-medium">Foreclosure type</td><td className="p-3">Judicial — Summit County Common Pleas; RealAuction mortgage sales Fridays 10:00 a.m.; delinquent tax sales Tuesdays 10:00 a.m.</td><td className="p-3 text-gray-500">Summit County Sheriff</td></tr>
                <tr className="bg-gray-50"><td className="p-3 font-medium">Probate court</td><td className="p-3">Summit County Probate Court, Judge Elinore Marsh Stormer — 209 South High Street, Akron OH 44308, phone 330-643-2350</td><td className="p-3 text-gray-500">Summit County Probate Court</td></tr>
        ...
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Akron Neighborhoods — Character Notes</h2>
          <div className="overflow-x-auto mb-6">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-brand-primary text-white">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-gray-50"><td className="p-3 font-medium">East Akron</td><td className="p-3">Diverse east-side neighborhood. Older two-stories and Cape Cods. Active investor market, lower price point.</td></tr>
                ...
                <tr className="bg-gray-50"><td className="p-3 font-medium">South Akron / Middlebury</td><td className="p-3">Mixed residential. Older stock, varied condition. Good for as-is and distressed sales.</td></tr>
                <tr className="bg-white"><td className="p-3 font-medium">Northwest Akron</td><td className="p-3">More suburban west-side areas including Fairlawn adjacency. Mix of older and post-war stock. Better retail fit for move-in-ready homes.</td></tr>
                <tr className="bg-gray-50"><td className="p-3 font-medium">Cuyahoga Falls</td><td className="p-3">Adjacent Summit County city. Mix of post-war and newer stock. Active retail and cash buyer market.</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">What Akron's Market Means for As-Is Sellers</h2>
          <p className="text-gray-700 mb-4">
            Akron's 73/100 Compete Score means move-in-ready homes attract competitive offers. But
          ...
          <p className="text-gray-700 mb-4">
            Summit County's RealAuction Friday sheriff sale, Summit County Probate Court (209 South
        ...
        <CashOfferForm variant="footer" headline="Get an Akron OH Cash Offer" sourcePage="/markets/akron-oh/market-report" />
      </div>
    </>
  );
}
