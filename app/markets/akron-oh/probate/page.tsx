...
const pageUrl = `${SITE_URL}/markets/akron-oh/probate`;

export const metadata: Metadata = {
  title: 'Probate Home Sale Akron OH — Summit County Estate Cash Buyer',
  description:
    'Need to sell a house through Summit County Probate Court in Akron OH? USA Home Buyers purchases probate properties for cash — offer in 24 hours, close after Letters of Authority issued.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'Can I sell a probate house in Akron before the estate closes?',
    answer:
      "Yes. You can accept an offer and sign a purchase contract during probate. The deed cannot transfer until the executor holds Letters of Authority from Summit County Probate Court — but we can have a signed contract in place and close quickly once that authorization is issued. We've done many Summit County probate closings and understand the timeline.",
  },
  {
    question: 'Where is Summit County Probate Court and who do I contact?',
    answer:
      "Summit County Court of Common Pleas — Probate Division, Judge Elinore Marsh Stormer. Address: 209 South High Street, Akron OH 44308. Phone: 330-643-2350. Open Monday–Friday. The court handles wills, estate administration, guardianship, and related matters in Summit County.",
  },
  {
    question: 'Do I need a real estate attorney to sell a probate property in Ohio?',
    answer:
      "Ohio does not require an attorney for a residential real estate closing — it's a title company state. However, for probate sales you typically need an estate attorney to open the probate case, get Letters of Authority, and authorize the sale. We work regularly with Akron-area probate attorneys and can recommend trusted professionals if needed.",
  },
  {
    question: 'What if the estate has liens, back taxes, or code violations?',
    answer:
      "We buy probate properties as-is, including those with open liens, back property taxes, Summit County code violations, or deferred maintenance. We resolve title issues at closing from the proceeds. Call 888-274-5006 and tell us about the property's situation — we'll give you a straight answer.",
  },
  {
    question: 'How long does probate take in Summit County?',
    answer:
      "A straightforward uncontested estate in Summit County typically takes 3–9 months. The real property does not need to wait for the entire estate to be settled — once the executor has Letters of Authority, a sale can proceed. We close within 7–14 days of the executor having that legal authority.",
  },
];
...
export default function AkronProbatePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          akronLocalBusinessSchema,
          articleSchema('Sell a Probate House in Akron OH', pageUrl, '2026-05-01'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Probate House in Akron OH — Summit County Estate Cash Buyer
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">
                Ohio estate sales go through Summit County Probate Court (209 South High Street,
                Akron OH 44308, Judge Elinore Marsh Stormer). Once the executor has Letters of
          ...
          <div>
            <CashOfferForm
              ...
              sourcePage="/markets/akron-oh/probate"
            />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <section className="my-8">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">
            Probate Real Estate Sales in Summit County, OH
          </h2>
          <p className="text-gray-700 mb-4">
            Summit County Probate Court handles estate administration for Akron and all of Summit
            County. The court is located at <strong>209 South High Street, Akron OH 44308</strong>
          ...
          <p className="text-gray-700 mb-4">
            ...
            to open the case and obtain Letters of Authority. We work with Akron-area probate
          ...
          <div className="border-l-4 border-purple-400 pl-4 mb-6">
            ...
            <p className="text-sm text-gray-700">
              ...
              process. In a straightforward Summit County estate, that's typically 3–9 months —
          ...
          <div className="border-l-4 border-orange-400 pl-4 mb-6">
            <h3 className="font-semibold text-brand-dark mb-1">Akron's probate housing stock</h3>
            <p className="text-sm text-gray-700">
              34.1% of Akron's housing units were built in 1939 or earlier. Probate properties
              in Goodyear Heights, Kenmore, Firestone Park, and East Akron often have decades
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Probate Home Sales in Akron OH" />
        ...
        <CashOfferForm
          variant="footer"
          headline="Ready to Sell an Akron OH Probate Property?"
          sourcePage="/markets/akron-oh/probate"
        />
      </div>
    </>
