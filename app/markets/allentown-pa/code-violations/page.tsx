  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling a Home with Code Violations in Allentown',
          description:
            'USA Home Buyers explains how Allentown homeowners can sell houses with city code violations, failed inspections, municipal liens, or unresolved repairs as-is for cash.',
          contentUrl: 'https://v3b.fal.media/files/b/0a95c0f7/HYZLhBnB0wizPc_TfbeNT_allentown-code-violations.mp4',
          thumbnailUrl: `${SITE_URL}/images/video-posters/allentown-code-violations-poster.jpg`,
