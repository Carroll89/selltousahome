  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Selling a Tenant-Occupied Property in Allentown',
          description:
            'USA Home Buyers explains how Allentown landlords can sell tenant-occupied rental properties as-is for cash, without evicting before closing.',
          contentUrl: 'https://v3b.fal.media/files/b/0a95c0f9/9i3z8bWrhNYAyWExOZasV_allentown-tenant-occupied.mp4',
          thumbnailUrl: `${SITE_URL}/images/video-posters/allentown-tenant-occupied-poster.jpg`,
