...
const pageUrl = `${SITE_URL}/markets/cleveland-oh/divorce-sale`;

export const metadata: Metadata = {
  title: 'Divorce Sale Help in Cleveland OH — Sell As-Is for Cash',
  description: 'When both sides need certainty, a written cash offer can create one price, one closing date, and a cleaner path for distributing proceeds. USA Home Buyers buys Cleveland OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with divorce sale in Cleveland OH?', answer: 'Yes. We buy Cleveland OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
