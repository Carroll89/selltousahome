...
const pageUrl = `${SITE_URL}/markets/cleveland-oh/probate`;

export const metadata: Metadata = {
  title: 'Probate Help in Cleveland OH — Sell As-Is for Cash',
  description: 'Probate and estate-title issues do not automatically block an offer. The title company and estate professionals confirm who has authority to sign before closing. USA Home Buyers buys Cleveland OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with probate in Cleveland OH?', answer: 'Yes. We buy Cleveland OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
