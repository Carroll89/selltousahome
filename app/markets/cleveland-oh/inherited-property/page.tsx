...
const pageUrl = `${SITE_URL}/markets/cleveland-oh/inherited-property`;

export const metadata: Metadata = {
  title: 'Inherited Property Help in Cleveland OH — Sell As-Is for Cash',
  description: 'Inherited houses often involve out-of-state heirs, cleanout problems, deferred repairs, and estate authority questions. USA Home Buyers buys Cleveland OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with inherited property in Cleveland OH?', answer: 'Yes. We buy Cleveland OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
