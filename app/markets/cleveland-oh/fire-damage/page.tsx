...
const pageUrl = `${SITE_URL}/markets/cleveland-oh/fire-damage`;

export const metadata: Metadata = {
  title: 'Fire Damage Help in Cleveland OH — Sell As-Is for Cash',
  description: 'Fire or smoke damage does not have to be repaired before a cash offer. We evaluate the property as-is and explain the offer before you commit. USA Home Buyers buys Cleveland OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with fire damage in Cleveland OH?', answer: 'Yes. We buy Cleveland OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
