...
const pageUrl = `${SITE_URL}/markets/cincinnati-oh/probate`;

export const metadata: Metadata = {
  title: 'Probate Help in Cincinnati OH — Sell As-Is for Cash',
  description: 'Probate and estate-title issues do not automatically block an offer. The title company and estate professionals confirm who has authority to sign before closing. USA Home Buyers buys Cincinnati OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with probate in Cincinnati OH?', answer: 'Yes. We buy Cincinnati OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
