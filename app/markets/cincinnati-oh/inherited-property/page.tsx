...
const pageUrl = `${SITE_URL}/markets/cincinnati-oh/inherited-property`;

export const metadata: Metadata = {
  title: 'Inherited Property Help in Cincinnati OH — Sell As-Is for Cash',
  description: 'Inherited houses often involve out-of-state heirs, cleanout problems, deferred repairs, and estate authority questions. USA Home Buyers buys Cincinnati OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with inherited property in Cincinnati OH?', answer: 'Yes. We buy Cincinnati OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
