...
const pageUrl = `${SITE_URL}/markets/cincinnati-oh/divorce-sale`;

export const metadata: Metadata = {
  title: 'Divorce Sale Help in Cincinnati OH — Sell As-Is for Cash',
  description: 'When both sides need certainty, a written cash offer can create one price, one closing date, and a cleaner path for distributing proceeds. USA Home Buyers buys Cincinnati OH houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with divorce sale in Cincinnati OH?', answer: 'Yes. We buy Cincinnati OH houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
