...
const FAQ_ITEMS = [
  { question: 'How fast can I sell before foreclosure in Wausau?', answer: 'We close in as few as 7 days. Wisconsin judicial foreclosure (Ch. 846) goes through Marathon County Circuit Court. After judgment, there\'s a 6-12 month redemption period, then sheriff\'s sale. Total: ~12 months. Call 888-274-5006.' },
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">Wisconsin judicial foreclosure takes about 12 months. USA Home Buyers purchases houses from Wausau homeowners facing foreclosure — written cash offer in 24 hours, close in 7-14 days. We cover all closing costs. Serving Marathon County. Call 888-274-5006.</p>
            </div>
