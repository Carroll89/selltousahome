  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a Fire-Damaged House in New Haven CT',
          description: 'No restoration required — we buy fire-damaged homes as-is in New Haven County',
          contentUrl: `${SITE_URL}/videos/new-haven-ct/fire-damage.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/new-haven-ct/fire-damage-poster.jpg`,
        }),
      ]} />
