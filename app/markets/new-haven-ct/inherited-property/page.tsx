  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell Inherited House in New Haven CT',
          description: 'We work with New Haven Probate Court — as-is, any condition',
          contentUrl: `${SITE_URL}/videos/new-haven-ct/inherited-property.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/new-haven-ct/inherited-property-poster.jpg`,
        }),
      ]} />
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Beneficiaries who inherit New Haven properties sometimes have expectations anchored to Zillow estimates, neighbor opinions, or what the property might have sold for in 2021's market peak. The 2026 market reality is different. New Haven's Zillow Research city ZHVI is $326,440 (2026-03-31) — representing the typical home across all neighborhoods. But in The Hill, Newhallville, and lower Fair Haven — where many inherited properties are concentrated — market values for distressed properties with deferred maintenance run substantially lower than the citywide average.
          </p>
          <p className="text-gray-700 mb-4">
