  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        faqSchema(FAQ_ITEMS),
        videoObjectSchema({
          name: 'Sell a House With Code Violations in New Haven CT',
          description: 'Open violations, condemnation notices — we buy as-is in New Haven County',
          contentUrl: `${SITE_URL}/videos/new-haven-ct/code-violations.mp4`,
          thumbnailUrl: `${SITE_URL}/videos/new-haven-ct/code-violations-poster.jpg`,
        }),
      ]} />
      ...
      <VideoEmbed
        src="/videos/new-haven-ct/code-violations.mp4"
        title="Sell a House With Code Violations in New Haven CT"
        poster="/videos/new-haven-ct/code-violations-poster.jpg"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            <strong>Lead paint.</strong> Every home built before 1978 potentially contains lead-based paint. In New Haven, where the housing stock skews heavily toward 1900–1940 construction, lead paint is nearly universal in the targeted neighborhoods. According to the CT Department of Public Health (portal.ct.gov/DPH), New Haven has had persistently elevated childhood lead exposure rates compared to state averages. LCI prioritizes lead violations, especially in rental properties where children occupy units.
          </p>
          <p className="text-gray-700 mb-4">
