  ...
  return (
    <>
      ...
      <VideoEmbed
        ...
        poster="/videos/new-haven-ct/probate-poster.jpg"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            USA Home Buyers provides written offers that are defensible to the Probate Court. We're not offering $0.50 on the dollar with no explanation — we price based on the property's actual as-is market value, the cost of renovation required to bring the property to retail condition, and the risk we're absorbing. Many New Haven Probate Court judges have seen cash buyer offers before and understand this pricing framework. For average-condition properties, cash offers typically land around 70–80% of fair market value — before factoring in repair costs, property condition, title issues, holding costs, and risk adjustments specific to your home. Call 888-274-5006.
          </p>
