...
const FAQ_ITEMS = [
  ...
  { question: 'How much do you pay for Boston homes?', answer: 'For average-condition properties, cash offers typically land around 70–80% of fair market value — before factoring in repair costs, property condition, title issues, holding costs, and risk adjustments specific to your home. Boston neighborhoods vary enormously — Mattapan homes may list at $450K-$600K while Back Bay exceeds $1M. We provide written offers based on comparable sales and condition.' },
