        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              ...
              <p className="text-white text-sm leading-relaxed">Done being a landlord in Boston? We buy tenant-occupied properties for cash — tenants in place, no eviction. Written offer in 24 hours. Close in 7-14 days. Call 888-274-5006.</p>
            </div>
