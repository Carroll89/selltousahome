...
const pageUrl = `${SITE_URL}/markets/dayton-oh/probate`;

export const metadata: Metadata = {
  title: 'Sell Probate House Dayton OH -- Montgomery County Estate Property',
  description: 'Selling a probate property in Dayton OH? We work with Montgomery County probate timelines -- cash offer, close when authorized.',
...
const FAQ_ITEMS = [
  ...
  { question: 'What closing costs apply?', answer: 'Montgomery County conveyance fee: $4.00/$1,000 + $0.50/parcel. USA Home Buyers covers all closing costs.' },
...
export default function DaytonProbatePage() {
  return (
    <>
      <SchemaMarkup
        schema={[
          daytonLocalBusinessSchema,
          articleSchema('Sell a Probate Property in Dayton OH -- Montgomery County Estate Sale', pageUrl, '2026-05-03'),
          faqSchema(FAQ_ITEMS),
        ]}
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell a Probate Property in Dayton OH -- Montgomery County Estate Sale
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">Quick Answer</p>
              <p className="text-white text-sm leading-relaxed">Selling a probate property in Dayton OH? We work with Montgomery County probate timelines -- cash offer, close when authorized.</p>
            </div>
          ...
          <div className="w-full">
            <CashOfferForm variant="hero" headline="Get Your Dayton OH Cash Offer" sourcePage="/markets/dayton-oh/probate" />
          </div>
        </div>
      </section>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <FAQSection items={FAQ_ITEMS} heading="FAQs -- Sell Probate House Dayton OH -- Montgomery County Estate Property" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Dayton OH Home?" sourcePage="/markets/dayton-oh/probate" />
      </div>
    </>
  );
}
