...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'The Zillow Research city ZHVI for Harrisburg is $263,369 as of 2026-03-31; Dauphin County context is $275,929 and should not be treated as the city value. Within city limits, Redfin and local MLS data show a median sale price closer to $152,500, reflecting Harrisburg\'s concentration of older row homes and working-class neighborhoods.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Redfin city housing-market data shows Harrisburg median sale prices up 5.2% year-over-year in March 2026; Zillow Research city ZHVI was up 3.9% YoY as of 2026-03-31. This is consistent with the broader Pennsylvania housing market trend, driven by low inventory, remote work demand, and affordability relative to Philadelphia and Pittsburgh.',
  },
  {
    question: 'How much do cash buyers pay for Harrisburg homes?',
    answer:
      'Cash buyers typically offer 70–80% of fair market value. For a Harrisburg home anchored to current city sale-price and ZHVI data, that typically means roughly $100,000–$210,700 before property-specific adjustments. The trade-off: no agent commissions (5–6%), no closing costs (the buyer covers), no repairs, and closing in 7–14 days instead of 70–85.',
  },
  {
...
export const metadata: Metadata = {
  ...
  description:
    'Current Harrisburg PA housing market data: Zillow Research city ZHVI $263,369 (2026-03-31), Redfin city median sale $152,500, 24 days on market, March 2026 source data with neighborhood breakdown.',
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Harrisburg PA Housing Market Report 2026',
    description:
      'Current data on Harrisburg PA home prices, days on market, inventory, and what it means if you\'re selling. Compiled from March 2026 source data.',
    url: PAGE_URL,
    type: 'article',
  },
};
...
const datasetSchema = {
  ...
  '@type': 'Dataset',
  name: 'Harrisburg PA Housing Market Data — March 2026 Source Data',
  description:
  ...
  variableMeasured: [
    { '@type': 'PropertyValue', name: 'Median Home Value (Zillow Research city ZHVI, 2026-03-31)', value: '$263,369' },
    { '@type': 'PropertyValue', name: 'Median Days on Market (Redfin city, Mar 2026)', value: '24' },
    { '@type': 'PropertyValue', name: 'Year-over-Year Price Change', value: '+3.9% Zillow city / +5.2% Redfin city' },
    { '@type': 'PropertyValue', name: 'Price Per Square Foot (Redfin city, Mar 2026)', value: '$101' },
  ],
};
...
const articleSchema = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Harrisburg PA Housing Market Report — March 2026 Source Data',
    ...
    <>
      ...
      <details className="mt-4 mb-8 border border-gray-200 rounded-lg max-w-4xl mx-auto">
        ...
        <div className="px4 pb-4 text-sm text-gray-600 leading-relaxed">
            ...
            <p className="mb-3">Zillow Research city ZHVI for Harrisburg is $263,369 as of 2026-03-31. Redfin city housing-market data for March 2026 shows a $152,500 median sale price — that gap tells you something about the mix of urban row homes and suburban single-family houses in the metro area.</p>
            <p className="mb-3">Redfin city housing-market data shows Harrisburg at 24 median days on market in March 2026. That&apos;s fast — it means when a well-priced home hits the MLS, it goes under contract quickly. But after going pending, you&apos;re still 45 to 60 days from closing. Inspections, appraisals, mortgage underwriting — all of that happens after the offer is accepted.</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border-l-4 border-brand-primary rounded-r-xl p-6 mb-10">
          ...
          <ul className="space-y-2 text-gray-700 text-sm">
            <li>
              ...
              up {REPORT_DATA.zillowZhviYoY} year-over-year per Zillow Research city ZHVI.
            </li>
            <li>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
            {[
              { label: 'Median Value (ZHVI)', value: REPORT_DATA.medianHomeValueZHVI, note: 'Zillow Research city, 2026-03-31' },
              { label: 'City-Limit Median Sale', value: REPORT_DATA.medianSalePriceCity, note: 'Redfin city, Mar 2026' },
              { label: 'Median DOM', value: `${REPORT_DATA.medianDaysOnMarket} days`, note: 'Redfin city, Mar 2026' },
              { label: 'Offer to Close', value: `${REPORT_DATA.daysToClose} days`, note: 'After going pending' },
              { label: 'YoY Price Change', value: `${REPORT_DATA.zillowZhviYoY} ZHVI / ${REPORT_DATA.redfinMedianSaleYoY} sale`, note: 'Zillow city / Redfin city' },
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ['Median home value (Zillow Research city ZHVI, 2026-03-31)', REPORT_DATA.medianHomeValueZHVI],
                  ...
                  ['Year-over-year price change', `${REPORT_DATA.zillowZhviYoY} Zillow city ZHVI / ${REPORT_DATA.redfinMedianSaleYoY} Redfin city median sale`],
          ...
          <p className="text-xs text-gray-500 mt-3">
            Sources: Zillow Research city ZHVI (2026-03-31) and Redfin city housing-market data (March 2026). Compiled: {REPORT_DATA.lastUpdated}.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-gray max-w-none text-sm text-gray-700 space-y-4">
            <p>
              Zillow Research city ZHVI is up <strong>3.9% year-over-year</strong> as of 2026-03-31; Redfin city median sale price is up <strong>5.2% year-over-year</strong> in March 2026. This is not a bubble — it&apos;s a supply problem. According to U.S. Census Bureau building permit data, Central Pennsylvania
            ...
            <p>
              The Harrisburg city Zillow ZHVI of <strong>{REPORT_DATA.medianHomeValueZHVI}</strong> is the Zillow Research city value for Harrisburg as of 2026-03-31. According to Redfin city housing-market data (March 2026), within Harrisburg city limits, the median sale price is closer
              to <strong>{REPORT_DATA.medianSalePriceCity}</strong> — a meaningful difference tied to transaction mix and the
            ...
            {[
              {
                ...
                desc: `According to Redfin city housing-market data, the ${REPORT_DATA.medianDaysOnMarket}-day median days on market is real. A well-priced, move-in ready home in a desirable neighborhood can still move quickly. The risk is still in the 45–60 day closing period — inspections, appraisals, and financing can still derail deals.`,
              },
              {
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-brand-dark text-white">
                  ...
                  <th className="px-4 py-3 text-left">Avg Median DOM</th>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 text-sm text-gray-500">
          ...
          <p className="mt-4 text-xs text-gray-400">
            Market data sourced from Zillow Research city ZHVI (2026-03-31) and Redfin city housing-market data (March 2026). Compiled {REPORT_DATA.lastUpdated}.
