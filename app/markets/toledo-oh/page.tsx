...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/markets/toledo-oh` },
};
...
const localBusinessSchema = {
  ...
  telephone: PHONE,
  url: `${SITE_URL}/markets/toledo-oh`,
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Sell My House Fast Toledo OH', item: `${SITE_URL}/markets/toledo-oh` },
  ],
};
