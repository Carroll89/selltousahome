    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="my-8">
          ...
          <p className="text-gray-700 mb-4">
            Per Redfin (March 2026), the Racine median sale price is $219,000, Redfin rates Racine 84/100 on its Compete Score, and homes sell in around 37 days. Per the Zillow Home Value Index (Zillow Research City ZHVI CSV, 2026-03-31), the typical Racine city home value is $208,908, up 4.9% year over year. The Wisconsin realty transfer fee under Wis. Stat. § 77.22 is $3.00 per $1,000 ($657 on a $219,000 sale); we cover it. Mount Pleasant village ZHVI is $336,759 (Zillow Research City ZHVI CSV, 2026-03-31).
          </p>
          <p className="text-gray-700 mb-4">
            Sheriff\'s sales at Racine County Circuit Court typically recover 60-75% of fair market value for the lender — often less. Our cash offers for distressed Racine foreclosure properties typically run 70–80% of FMV before property-specific adjustments, with the seller preserving any equity above the mortgage payoff. If your Racine cream brick cottage has $30K of equity and you\'re six weeks from the sheriff\'s sale, the math on selling now versus letting the sale happen is stark: either you walk with the $30K, or the lender and buyer at auction absorb it.
          </p>
          <p className="text-gray-700 mb-4">
