...
const market = getMiniSiteMarket("racine-mount-pleasant-wi");
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/markets/racine-mount-pleasant-wi/resources` },
};

export default function ResourcesPage() {
  return (
    <MarketResourcesPage
      marketSlug={"racine-mount-pleasant-wi"}
