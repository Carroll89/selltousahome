...
export const metadata: Metadata = {
  title: 'Sell Fire Damaged House Racine WI',
  description:
    'Selling a fire-damaged house in Racine WI? We buy fire-damaged properties as-is. No restoration required. Written offer in 24 hours.',
...
const FAQ_ITEMS = [
  {
    ...
    answer: 'Yes. We buy fire-damaged properties in Racine at any stage — partial damage with smoke and water, structural fire damage, total losses. We assess the land value, salvageable structure, and remediation costs to make a fair offer.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We have purchased condemned and red-tagged properties in Racine. Condemnation limits your conventional sale options but not your cash sale options. We can close quickly and take responsibility for addressing the condemnation order.',
  },
  {
  ...
  return (
    <>
      <SchemaMarkup schema={[
        ...
        articleSchema('Sell Your Fire-Damaged Racine WI House — Fast, As-Is', pageUrl, '2026-04-17'),
        faqSchema(FAQ_ITEMS),
      ]} />
      ...
      <section className="relative text-white py-16 px-4 overflow-hidden">
        <picture className="absolute inset-0 w-full h-full">
          ...
          <img
            ...
            alt="Racine WI homes — Sell Your Fire-Damaged Racine WI House — Fast, As-Is"
            fetchPriority="high"
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Sell Your Fire-Damaged Racine WI House — Fast, As-Is
            </h1>
            <div className="bg-white/10 border border-white/20 rounded-xl p-4 mb-4">
              <p className="text-blue-100 text-sm font-medium mb-1">TL;DR</p>
              <p className="text-white text-sm leading-relaxed">USA Home Buyers purchases fire-damaged properties in Racine WI — partial burns, smoke damage, total losses. We buy as-is, no restoration required. Written cash offer based on land value and salvageable structure in 24 hours. Call 888-440-5250.</p>
            </div>
          ...
          <div>
            <CashOfferForm variant="hero" headline="Get Your Cash Offer" subheadline="Written offer in 24 hours. We cover all closing costs." sourcePage="/markets/racine-mount-pleasant-wi/fire-damage" />
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <FAQSection items={FAQ_ITEMS} heading="FAQs — Fire Damage in Racine WI" />
        ...
        <CashOfferForm variant="footer" headline="Ready to Sell Your Racine WI Property?" sourcePage="/markets/racine-mount-pleasant-wi/fire-damage" />
      </div>
    </>
  );
}
