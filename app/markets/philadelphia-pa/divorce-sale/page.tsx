...
const pageUrl = `${SITE_URL}/markets/philadelphia-pa/divorce-sale`;

export const metadata: Metadata = {
  title: 'Divorce Sale Help in Philadelphia PA — Sell As-Is for Cash',
  description: 'When both sides need certainty, a written cash offer can create one price, one closing date, and a cleaner path for distributing proceeds. USA Home Buyers buys Philadelphia PA houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with divorce sale in Philadelphia PA?', answer: 'Yes. We buy Philadelphia PA houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
