...
const pageUrl = `${SITE_URL}/markets/philadelphia-pa/inherited-property`;

export const metadata: Metadata = {
  title: 'Inherited Property Help in Philadelphia PA — Sell As-Is for Cash',
  description: 'Inherited houses often involve out-of-state heirs, cleanout problems, deferred repairs, and estate authority questions. USA Home Buyers buys Philadelphia PA houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with inherited property in Philadelphia PA?', answer: 'Yes. We buy Philadelphia PA houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
