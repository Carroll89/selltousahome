...
const pageUrl = `${SITE_URL}/markets/philadelphia-pa/probate`;

export const metadata: Metadata = {
  title: 'Probate Help in Philadelphia PA — Sell As-Is for Cash',
  description: 'Probate and estate-title issues do not automatically block an offer. The title company and estate professionals confirm who has authority to sign before closing. USA Home Buyers buys Philadelphia PA houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with probate in Philadelphia PA?', answer: 'Yes. We buy Philadelphia PA houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
