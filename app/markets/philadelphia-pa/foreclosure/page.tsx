...
const pageUrl = `${SITE_URL}/markets/philadelphia-pa/foreclosure`;

export const metadata: Metadata = {
  title: 'Foreclosure Help in Philadelphia PA — Sell As-Is for Cash',
  description: 'If a foreclosure deadline is creating pressure, a direct cash sale can be evaluated quickly so you understand whether selling before the process advances is realistic. USA Home Buyers buys Philadelphia PA houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with foreclosure in Philadelphia PA?', answer: 'Yes. We buy Philadelphia PA houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
