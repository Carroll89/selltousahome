...
const pageUrl = `${SITE_URL}/markets/philadelphia-pa/tenant-occupied`;

export const metadata: Metadata = {
  title: 'Tenant-Occupied Help in Philadelphia PA — Sell As-Is for Cash',
  description: 'Rental properties can be sold with tenants still in place. A cash sale can reduce showings, inspection friction, and landlord coordination headaches. USA Home Buyers buys Philadelphia PA houses as-is for cash. Call 888-274-5006.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  { question: 'Can USA Home Buyers help with tenant-occupied in Philadelphia PA?', answer: 'Yes. We buy Philadelphia PA houses as-is and can evaluate the property quickly. Title, estate authority, tenant, lien, or court issues are confirmed before closing. Call 888-274-5006.' },
