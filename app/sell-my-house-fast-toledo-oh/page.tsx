  ...
  return (
    <>
      <SchemaMarkup schema={[localBusinessSchema, faqSchema(FAQ_ITEMS), breadcrumbSchema, videoObjectSchema({
          ...
          description:
            'A short overview of how USA Home Buyers helps Toledo, OH homeowners sell as-is for cash with no repairs, no agent commissions, and a no-obligation offer.',
      ...
      <section className="relative text-white py-8 md:py-16 px-4 overflow-hidden bg-brand-dark">
        <picture className="absolute inset-0 w-full h-full">
          <source
            srcSet="/images/optimized/toledo-oh-representative-hero-640.jpg 640w, /images/optimized/toledo-oh-representative-hero-828.jpg 828w, /images/optimized/toledo-oh-representative-hero-1080.jpg 1080w, /images/optimized/toledo-oh-representative-hero-1200.jpg 1200w"
            sizes="100vw"
          />
          <img
            src="/images/optimized/toledo-oh-representative-hero-1200.jpg"
            alt="Representative Toledo OH older single-family home — sell your house fast for cash"
