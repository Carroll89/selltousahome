...
const pageUrl = `${SITE_URL}/guides/sell-house-fast-kenosha-wi-2026`;

export const metadata: Metadata = {
  title: 'Sell House Fast Kenosha WI 2026',
  description:
    'Complete guide to selling your house fast in Kenosha WI. Compare cash buyers, traditional listing, FSBO, and iBuyer options with local Kenosha data.',
  alternates: { canonical: pageUrl },
};

const FAQ_ITEMS = [
  {
    question: 'What is the fastest way to sell a house in Kenosha WI?',
    answer: 'The fastest path is selling to a cash buyer like USA Home Buyers. Written offer in 24 hours, close in 7–14 days. No repairs, no inspections, no bank financing delays. Traditional listing in Kenosha takes 35 days on market (median) plus 30-45 days to close after accepting an offer — total: 60-90 days minimum.',
  },
  {
    question: 'How much do cash buyers pay in Kenosha WI?',
    answer: 'Cash offers for Kenosha homes typically range from 68-80% of fair market value. According to Zillow, the Kenosha median home value is $225,000. This is below what you might net from a traditional listing — but after subtracting agent commissions (5-6%), repair costs, carrying costs, and seller closing costs (including $3.00 per $1), the difference is often smaller than it appears.',
  },
  {
    question: 'Is selling to a cash buyer worth it in Wisconsin?',
    answer: 'For many Kenosha sellers, yes — especially if the property needs work, the timeline is urgent (foreclosure, divorce, relocation), or the owner lives out of state. The speed, certainty, and zero-repair-cost advantage compounds significantly in situations where a traditional sale would require significant pre-listing investment.',
  },
  {
    question: 'What are the transfer taxes when selling a house in Kenosha WI?',
    answer: '$3.00 per $1,000 (realty transfer fee, seller pays). When you sell to USA Home Buyers, we cover all closing costs.',
  },
  {
    question: 'How does Wisconsin foreclosure work for Kenosha homeowners?',
    answer: 'Judicial (Kenosha County Circuit Court, 10-14 months, Ch. 846 Wis. Stats.). If you are behind on payments, a cash sale before the foreclosure completes is typically your best option to preserve equity.',
  },
];

export default function SellHouseFastKenosha2026Page() {
  return (
    <>
      <SchemaMarkup schema={[
        kenoshWILocalBusinessSchema,
        articleSchema('How to Sell Your House Fast in Kenosha WI — 2026 Guide', pageUrl, '2026-04-16', '2026-04-16'),
        faqSchema(FAQ_ITEMS),
      ]} />

      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="text-sm text-blue-600 mb-4">
          <Link href="/" className="hover:underline">Home</Link> › <Link href="/sell-house-fast-wisconsin" className="hover:underline">Wisconsin</Link> › <Link href="/markets/kenosha-wi" className="hover:underline">Kenosha</Link> › Guide
        </nav>

        <h1 className="text-3xl md:text-4xl font-bold text-brand-dark mb-4">
          How to Sell Your House Fast in Kenosha WI — 2026 Guide
        </h1>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Your 4 Options for Selling a House in Kenosha WI</h2>
          ...
          <p className="mt-3 text-xs text-gray-500">Note: iBuyer programs have limited availability in Kenosha WI. Check current coverage before assuming this option is available in your zip code.</p>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">Kenosha WI Market Data — 2026</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <p className="text-sm text-gray-500 mb-1">Median home value</p>
              <p className="text-2xl font-bold text-brand-dark">$225,000</p>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">How to Verify a Cash Home Buyer in Kenosha WI</h2>
          <p className="text-gray-700 mb-4">Before accepting any cash offer in Kenosha, verify:</p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm mb-4">
            ...
            <li>Business registration — verifiable with the Wisconsin Secretary of State</li>
          ...
          <p className="text-gray-700 mb-4">
            USA Home Buyers provides all of the above. We've closed transactions throughout Wisconsin and our process is fully documented in writing.
          </p>
        </section>

        <FAQSection items={FAQ_ITEMS} heading="FAQ — Selling Your House Fast in Kenosha WI" />

        <section className="mb-8 mt-10">
          <h2 className="text-xl font-bold text-brand-dark mb-4">External Resources for Kenosha WI Sellers</h2>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>• <a href="https://www.zillow.com" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:underline">Zillow Home Value Index</a> — Kenosha market data</li>
            ...
            <li>• <a href="https://www.census.gov" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:underline">U.S. Census Bureau</a> — Kenosha County housing and demographic data</li>
          </ul>
        </section>

        <CashOfferForm variant="footer" headline="Get a Cash Offer for Your Kenosha WI Home" sourcePage="/guides/sell-house-fast-kenosha-wi-2026" />
      </div>
    </>
  );
}
