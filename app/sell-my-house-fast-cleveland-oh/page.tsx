  ...
  return (
    <>
      <SchemaMarkup schema={[localBusinessSchema, faqSchema(FAQ_ITEMS), breadcrumbSchema, videoObjectSchema({
          name: 'Sell Your House Fast in Cleveland, OH',
          description:
            'A short overview of how USA Home Buyers helps Cleveland, OH homeowners sell as-is for cash with no repairs, no agent commissions, and a no-obligation offer.',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <VideoEmbed
          ...
          title="Sell Your House Fast in Cleveland, OH"
