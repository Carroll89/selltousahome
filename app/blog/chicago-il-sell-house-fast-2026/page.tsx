    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-700 mb-4">Illinois is a <strong>judicial foreclosure</strong> state. In Cook County, mortgage foreclosure cases go through the Circuit Court of Cook County, Chancery Division. Illinois homeowners typically have a redemption period of <strong>7 months from service of summons</strong> or <strong>3 months from entry of judgment of foreclosure</strong>, whichever is later. Uncontested Illinois foreclosures often take <strong>12–15 months</strong>, but timing is case-specific.</p>
          ...
          <p className="text-gray-700 mb-4">Chicago sellers should understand the tax stack before comparing offers. Plan for four cost items:</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <li><strong>City of Chicago real property transfer tax:</strong> total $5.25 per $500. Chicago sellers typically pay $1.50 per $500 and buyers pay $3.75 per $500.</li>
            <li><strong>Cook County deed recording fee:</strong> $107 flat for deeds, effective April 1, 2024.</li>
          </ul>
          <p className="text-gray-700 mb-4">On a $410,000 sale, the seller-side city transfer tax alone is about <strong>$1,230</strong> using the seller-side city rate. That does not include agent commissions, attorney fees, title charges, payoff items, repairs, or credits negotiated after inspection.</p>
