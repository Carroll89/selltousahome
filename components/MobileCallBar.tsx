...
export function MobileCallBar({ phone }: MobileCallBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_-2px_4px_-2px_rgba(0,0,0,0.08)]">
      <a
        href={`tel:${tel}`}
